...
set filenames=GlobalDefinitions,VueComponents,Utilities,Skill,Tile,Map,Structures,Cell,Table,HeroInfo,Unit,UnitManager,GlobalBattleContext,DamageCalculationUtility,DamageCalculator,DamageCalculatorWrapper,TurnSetting,AudioManager,AetherRaidDefensePresets,SkillDatabase,HeroDatabase,AppData,SettingManager,Main_ImageProcessing,Main_OriginalAi,Main_MouseAndTouch,Main
