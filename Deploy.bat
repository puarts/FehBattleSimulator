...
rem �X�e�[�^�X�v�Z�@
call %~dp0MergeSourcesAndCompress.bat FehStatusCalculator GlobalDefinitions,Utilities,SkillConstants,Skill,SkillImpl,BattleMapElement,HeroInfoConstants,HeroInfo,UnitConstants,Unit,StatusCalcMain
