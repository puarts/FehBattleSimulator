...
import { DamageCalcEnv, DamageCalculator as DamageCalcCore, DamageType, GameMode } from './DamageCalculator.js';
...
import { BlessingType, BookVersions, MoveType, StatusType } from './HeroInfoConstants.js';
import { NoneValue, PassiveA, PassiveB, PassiveC, PassiveS, PassiveX, SkillType, Special, Weapon, WeaponRefinementType, WeaponType } from './SkillConstants.js';
        ...
        if (this.roundRobinCombatMode === RoundRobinCombatMode.Offense) {
            ...
            startProgressiveProcess(length,
                function (iter) {
                    ...
                    atkUnit.applyReservedState(true);
            ...
            startProgressiveProcess(length,
                function (iter) {
                    ...
                    defUnit.applyReservedState(true);
