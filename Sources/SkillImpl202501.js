    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        [
            ...
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(
                // X = 20% of unit's Spd + total value of Atk and Spd【Great Talent】),
                ADD_NODE(
...
// Invincible Sister
{
    let skillId = Special.InvincibleSister;
    setSpecialCountAndType(skillId, 5, false, false, true, false);
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        [
            ...
            TARGETS_FIRST_FOLLOW_UP_ATTACK_DEALS_X_DAMAGE_NODE(
                // (X = 50% of foe's Atk + total value of unit's Atk and Spd【Great Talent】),
                ADD_NODE(
                    PERCENTAGE_NODE(50, FOES_ATK_NODE),
                    ADD_NODE(UNITS_ATK_GREAT_TALENT_NODE, UNITS_SPD_GREAT_TALENT_NODE),
                ),
            ),
            NON_STATS_SKILL_USING_STATS_HOOKS,
...
// Null Uplift A/S
{
    let skillId = PassiveC.NullUpliftAS;
    setForAlliesHooks(skillId,
        IS_TARGET_IN_CARDINAL_DIRECTIONS_OF_SKILL_OWNER_NODE,
        // grants Atk/Spd+5
        GRANTS_ATK_SPD_TO_TARGET_DURING_COMBAT_NODE(5),
        // and unit and ally deal +5 damage during their combat
        TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(5),
    );
    FOR_ALLIES_GRANTS_EFFECTS_TO_ALLIES_USING_STATS_DURING_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // (excluding area-of-effect Specials),
        ...
        // during combat.
        IF_NODE(IS_TARGET_IN_CARDINAL_DIRECTIONS_OF_SKILL_OWNER_NODE,
            // and also, if their Spd > foe's Spd,
            IF_NODE(GT_NODE(TARGETS_EVAL_SPD_NODE, FOES_EVAL_SPD_NODE),
                // neutralizes effects that guarantee foe's follow-up attacks
...
// Ethereal Gungnir
{
    let skillId = Weapon.EtherealGungnir;
    // Mt: 14
    // Rng: 2
    ...
    setAfterStartOfTurnEffectsTriggerOnPlayerOrEnemyPhaseHooks(skillId, NODE_FUNC(
        // grants any (Bonus) effects active on foes
    ...
    setForFoesSkillsDuringCombatHooks(skillId,
        ...
        INFLICTS_ATK_SPD_DEF_RES_ON_FOE_DURING_COMBAT_NODE(xNode),
        SKILL_EFFECT_NODE(
            ...
            DEALS_DAMAGE_TO_TARGET_AS_COMBAT_BEGINS_NODE(xNode),
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
            CACHE_NODE(`${skillId}_grants_stats`,
                MULT_NODE(xNode, 2),
            ),
        ),
        [
            ...
            // (excluding area-of-effect Specials),
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(PERCENTAGE_NODE(20, UNITS_RES_NODE)),
...
// Covetous One
{
    ...
    setAtStartOfTurnAndAfterUnitActsIfCantoAfterCanto(skillId, NODE_FUNC(
        ...
        FOR_EACH_UNIT_NODE(
            ...
            IF_NODE(LT_NODE(TARGETS_EVAL_RES_NODE, ADD_NODE(SKILL_OWNERS_EVAL_RES_ON_MAP, 5)),
                // inflicts Atk/Res-7, (Exposure), and (Discord) on those foes
                INFLICTS_ATK_RES_ON_TARGET_ON_MAP_NODE(7),
                INFLICTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(StatusEffectType.Exposure, StatusEffectType.Discord),
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(7),
...
}
{
    ...
    // Range: 2 Style
    setUnitCanUseFollowingStyle(skillId, StyleType.RANGE_2);
    // Unit can attack foes 2 spaces away
    // (unit cannot attack adjacent foes).
    // Cannot move through spaces within 2 spaces of foe
    // that has triggered the Bulwark effect
    ...
    // or foe's Range is the same as the distance
    // between unit and foe.
    // After-combat movement effects do not occur.
    // Skill effect's Range is treated as 1.
    // This Style can be used only once per turn.
}
{
    let skillId = getSpecialRefinementSkillId(Weapon.HolyGradivus);
    // At start of player phase
    // or enemy phase,
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            INFLICTS_ATK_DEF_ON_FOE_DURING_COMBAT_NODE(
                // 10% of unit's Def at start of combat, +6,
                PERCENTAGE_ADD_NODE(10, UNITS_DEF_AT_START_OF_COMBAT_NODE, 6),
            ),
        ),
        SKILL_EFFECT_NODE(
            // and deals damage = 20% of unit's Def
            // during combat
            // (excluding area-of-effect Specials).
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(PERCENTAGE_NODE(20, UNITS_DEF_NODE)),
        ),
    );
}

{
    let skillId = getNormalSkillId(Weapon.AgneasArrow);
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // 自分から攻撃した時、または、周囲2マス以内に味方がいる時、戦闘中、攻撃、速さ+6、自分の追撃不可を無効、かつ、
        IF_UNIT_INITIATES_COMBAT_OR_IS_WITHIN_2_SPACES_OF_AN_ALLY(
            GRANTS_ATK_SPD_TO_TARGET_DURING_COMBAT_NODE(6),
            NEUTRALIZES_EFFECTS_THAT_PREVENT_TARGETS_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE,
            // 奇数ターンなら
            IF_ELSE_NODE(IS_ODD_TURN_NODE,
                // 敵の速さ、魔防の強化を無効
                NEUTRALIZES_FOES_EACH_BONUSES_TO_STATS_DURING_COMBAT_NODE(false, true, false, true),
                // 偶数ターンなら
                // 自分の攻撃、速さの弱化を無効(無効になるのは、鼓舞や応援等の+効果)
                NEUTRALIZES_EACH_PENALTIES_ON_TARGETS_NODE(true, true, false, false),
            ),
        ),
    ));
}
{
    let skillId = getRefinementSkillId(Weapon.AgneasArrow);
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            // (excluding area-of-effect Specials),
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(PERCENTAGE_NODE(20, UNITS_SPD_NODE)),
        ),
    );
}
{
    let skillId = getSpecialRefinementSkillId(Weapon.AgneasArrow);
    // Enables [Canto (Rem.; Min 1)].
    enablesCantoRemPlusMin(skillId, 0, 1);
    // At start of turn and after unit acts
    // (if Canto triggers, after Canto),
    setAtStartOfTurnAndAfterUnitActsIfCantoAfterCanto(skillId, NODE_FUNC(
        // inflicts Spd/Res-7, [Sabotage], and [Discord]
...
{
    let skillId = getNormalSkillId(Weapon.AsuraBlades);
...
{
    let skillId = getRefinementSkillId(Weapon.AsuraBlades);
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // Grants Atk/Spd/Def/Res+5.
        GRANTS_ALL_STATS_PLUS_5_TO_TARGET_DURING_COMBAT_NODE,
        // Unit attacks twice
        // (even if foe initiates combat).
...
{
    let skillId = getSpecialRefinementSkillId(Weapon.AsuraBlades);
    // At start of turn and after unit acts
    // (if Canto triggers, after Canto),
    setAtStartOfTurnAndAfterUnitActsIfCantoAfterCanto(skillId, NODE_FUNC(
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_UNIT_INITIATES_COMBAT_OR_IS_WITHIN_2_SPACES_OF_AN_ALLY(
            ...
            X_NUM_NODE(
                // and unit deals +X × 5 damage
                // (excluding area-of-effect Specials;
                TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(MULT_NODE(READ_NUM_NODE, 5)),
...
{
    let skillId = getNormalSkillId(Weapon.ShadowBreath);
...
{
    let skillId = getRefinementSkillId(Weapon.ShadowBreath);
    // At start of player phase or enemy phase,
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        // grants Atk/Res+6, [En Garde], [Fringe Bonus],
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        // or foe's HP ≥ 75% at start of combat,
        IF_FOE_INITIATES_COMBAT_OR_IF_FOES_HP_GTE_75_PERCENT_AT_START_OF_COMBAT(
            // inflicts Atk/Def/Res-6 to foe,
            INFLICTS_ATK_DEF_RES_ON_FOE_DURING_COMBAT_NODE(6),
...
{
    let skillId = getSpecialRefinementSkillId(Weapon.ShadowBreath);
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        // If foe initiates combat
        // or foe's HP ≥ 75% at start of combat,
        ...
        SKILL_EFFECT_NODE(
            ...
            INFLICTS_ATK_DEF_RES_ON_FOE_DURING_COMBAT_NODE(
                // (X = 10% of unit's Res at start of combat, + 5),
                PERCENTAGE_ADD_NODE(10, UNITS_RES_AT_START_OF_COMBAT_NODE, 5),
            ),
        ),
        SKILL_EFFECT_NODE(
            // reduces damage from foe's attacks
            // by 20% of unit's Res (excluding area-of-effect Specials),
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(
                PERCENTAGE_NODE(20, UNITS_RES_NODE)
            ),
            // and reduces damage from foe's Specials
            // by an additional 20% of unit's Res during combat
            // (excluding area-of-effect Specials),
...
{
    let skillId = getNormalSkillId(Weapon.PolishedFang);
    // 戦闘開始時、敵のHPが75%以上なら、
    // 戦闘中、攻撃、守備+6、かつ、
    // 守備が敵より1以上高い時、戦闘中、敵の攻撃でダメージを受けた時の奥義発動カウント変動量+1(同系統効果複数時、最大値適用)、
    // ダメージ+5(戦闘前奥義も含む)
    setCondHooks(skillId,
        ...
        [
            NON_STATS_SKILL_USING_STATS_HOOKS,
            NODE_FUNC(
                IF_NODE(GTE_NODE(UNITS_EVAL_DEF_NODE, FOES_EVAL_DEF_NODE),
...
{
    let skillId = getRefinementSkillId(Weapon.PolishedFang);
    setCondHooks(skillId,
        ...
        [
            AT_START_OF_COMBAT_HOOKS,
            NODE_FUNC(
                // grants Atk/Def+6 and Spd/Res+5 to unit,
                GRANTS_ATK_DEF_TO_TARGET_DURING_COMBAT_NODE(6),
                GRANTS_SPD_RES_TO_TARGET_DURING_COMBAT_NODE(5),
            ),
        ],
        [
            NON_STATS_SKILL_USING_STATS_HOOKS,
            NODE_FUNC(
                ...
                // (only highest value applied; does not stack),
                GRANTS_SPECIAL_COOLDOWN_CHARGE_PLUS_1_TO_UNIT_PER_ATTACK_DURING_COMBAT_NODE,
                // and inflicts Special cooldown charge -1 on foe per attack
                // during combat (only highest value applied; does not stack).
...
{
    let skillId = getSpecialRefinementSkillId(Weapon.PolishedFang);
    // For foes within 3 rows or 3 columns centered on unit,
    setForFoesSkillsDuringCombatHooks(skillId,
        IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE,
        ...
        SKILL_EFFECT_NODE(
            // neutralizes foe's bonuses,
            NEUTRALIZES_FOES_BONUSES_TO_STATS_DURING_COMBAT_NODE,
            // and foe suffers guaranteed follow-up attacks during combat.
...
{
    let skillId = getNormalSkillId(Weapon.LoyalistAxe);
    // 敵から攻撃された時、または、戦闘開始時、敵のHPが75%以上の時、
    setCondHooks(skillId,
        OR_NODE(DOES_FOE_INITIATE_COMBAT_NODE_OR_IS_FOES_HP_GTE_75_PERCENT_AT_START_OF_COMBAT_NODE),
        // 戦闘中、敵の攻撃、守備-6、かつ、
        [
            AT_START_OF_COMBAT_HOOKS,
            NODE_FUNC(
        ...
        [
            ...
            NODE_FUNC(
                // 敵が追撃可能なら、最初に受けた攻撃のダメージを75%軽減
                IF_NODE(CAN_TARGETS_FOE_MAKE_FOLLOW_UP_INCLUDING_POTENT_NODE,
                    REDUCES_DAMAGE_FROM_FOES_FIRST_ATTACK_BY_N_PERCENT_DURING_COMBAT_NODE(75),
                ),
            ),
        ],
    );
...
{
    let skillId = getRefinementSkillId(Weapon.LoyalistAxe);
    // Accelerates Special trigger (cooldown count-1).
    let nodeFunc = NODE_FUNC(
        // applies [Divine Vein (Stone)] to unit's space
        // and spaces within 2 spaces of unit
        // for 1 turn.
        FOR_EACH_SPACES_NODE(
            SPACES_WITHIN_N_SPACES_OF_SKILL_OWNER_NODE(2),
            APPLY_DIVINE_VEIN_NODE(DivineVeinType.Stone, SKILL_OWNER_GROUP_NODE, 1),
        ),
    );
    ...
    // or, if defending in Aether Raids,
    // at the start of enemy phase,
    AT_START_OF_ENEMY_PHASE_HOOKS.addSkill(skillId, NODE_FUNC(
    ...
    setCondHooks(skillId,
        ...
        [
            AFTER_FOLLOW_UP_CONFIGURED_HOOKS,
            NODE_FUNC(
                // and also, if foe can perform a follow-up attack,
                // reduces damage from foe's first attack by 75%
                // ("first attack" normally means only the first strike;
                // for effects that grant "unit attacks twice,"
                // it means the first and second strikes).
                IF_NODE(CAN_TARGETS_FOE_MAKE_FOLLOW_UP_INCLUDING_POTENT_NODE,
                    REDUCES_DAMAGE_FROM_FOES_FIRST_ATTACK_BY_N_PERCENT_DURING_COMBAT_INCLUDING_TWICE_NODE(75),
                ),
            ),
        ],
    );
...
{
    let skillId = getSpecialRefinementSkillId(Weapon.LoyalistAxe);
    SkillEffectRegistrar.registerAllyTargetingBasicSkills(skillId,
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        [
            ...
            // by an additional 20% of unit's Def
            // (excluding area-of-effect Specials),
            REDUCES_DAMAGE_FROM_FOES_SPECIALS_BY_X_EXCLUDING_AOE_SPECIAL_NODE(
                PERCENTAGE_NODE(20, UNITS_DEF_NODE)
            ),
        ...
        GRANTS_SPECIAL_COOLDOWN_COUNT_MINUS_N_TO_TARGET_BEFORE_TARGETS_FIRST_ATTACK_DURING_COMBAT_NODE(1),
        // and any "reduces damage by X%" effect
...
{
    let skillId = Weapon.SoulfulLance;
    // 自身を中心とした縦3列と横3列の敵は、
    // 戦闘中、攻撃、速さ、守備、魔防-5、
    // 奥義以外のスキルによる「ダメージを○○％軽減」を半分無効(無効にする数値は端数切捨て)(範囲奥義を除く)、
    ...
    // 敵から攻撃された時または戦闘開始時、敵のHPが75%以上の時、戦闘中、自身の弱化を無効
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        DOES_FOE_INITIATE_COMBAT_NODE_OR_IS_FOES_HP_GTE_75_PERCENT_AT_START_OF_COMBAT_NODE,
        NEUTRALIZES_PENALTIES_ON_TARGETS_NODE,
    );
...
{
    let skillId = getSpecialRefinementSkillId(Weapon.SoulfulLance);
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        // If foe initiates combat
        // or foe's HP ≥ 75% at start of combat,
        DOES_FOE_INITIATE_COMBAT_NODE_OR_IS_FOES_HP_GTE_75_PERCENT_AT_START_OF_COMBAT_NODE,
...
// 🗡️ Covert Duality
{
    let skillId = Weapon.CovertDuality;
    // Mt: 9 Rng: 2
    // Accelerates Special trigger (cooldown count-1).
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        X_NUM_NODE(
            ...
            // (excluding area-of-effect Specials;
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(MULT_NODE(READ_NUM_NODE, 3)),
...
// 🅰️ Rapid Slice
{
    let skillId = PassiveA.RapidSlice;
    // At start of player phase or enemy phase,
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        // if unit is within 2 spaces of an ally,
        IF_NODE(IS_TARGET_WITHIN_2_SPACES_OF_TARGETS_ALLY_NODE,
    ...
    NON_STATS_SKILL_USING_STATS_HOOKS.addSkill(skillId, NODE_FUNC(
        // If unit initiates combat
        IF_NODE(DOES_UNIT_INITIATE_COMBAT_NODE,
            IF_ELSE_NODE(
                ...
                IF_NODE(GTE_NODE(UNITS_EVAL_SPD_NODE, ADD_NODE(FOES_EVAL_SPD_NODE, 20)),
                ...
                IF_NODE(GTE_NODE(UNITS_EVAL_SPD_NODE, ADD_NODE(FOES_EVAL_SPD_NODE, 5)),
                    // grants “effective against all weapon types” to unit during combat.
                    GRANTS_EFFECTIVE_AGAINST_ALL_WEAPON_TYPES_TO_UNIT_DURING_COMBAT,
                ),
            ),
...
// 🅲 Lookout Smog
{
    let skillId = PassiveC.LookoutSmog;
    // Enables [Canto (2)].
    enablesCantoN(skillId, 2);
    // When Canto triggers,
    WHEN_CANTO_TRIGGERS_HOOKS.addSkill(skillId, NODE_FUNC(
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        AND_NODE(DOES_UNIT_INITIATE_COMBAT_NODE, CAN_FOES_ATTACK_TRIGGER_FOES_SPECIAL_NODE),
...
// 🗡️ Bow of Stealth
{
    let skillId = Weapon.BowOfStealth;
    // Mt: 8 Rng: 2 Eff: 🪶
    // Accelerates Special trigger (cooldown count-1).
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        OR_NODE(DOES_UNIT_INITIATE_COMBAT_NODE, IS_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE),
        // grants bonus to unit's Atk/Spd/Def/Res =
        GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
            // number of foes within 3 rows or 3 columns centered on unit × 3, + 5 (max 14),
            MULT_ADD_MAX_NODE(NUM_OF_FOES_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_UNIT_NODE, 3, 5, 14),
...
// 🅰️ Ninja-Zap
{
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        ...
        IF_NODE(EQ_NODE(FOR_FOE_NODE(TARGETS_COLOR_NODE), ColorType.Colorless),
    ...
    UNIT_CAN_MOVE_TO_A_SPACE_HOOKS.addSkill(skillId, () =>
        SPACES_WITHIN_N_SPACES_OF_SPACES_NODE(2,
            // If any space within 2 spaces of unit
            // meets any of the following conditions,
            FILTER_SPACES_NODE(SPACES_WITHIN_N_SPACES_OF_TARGET_NODE(2),
                predNode,
            ),
        ),
    );
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        X_NUM_NODE(
            // unit deals +X damage
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(READ_NUM_NODE),
            // reduces damage from foe’s attacks by X
            // (excluding area-of-effect Specials),
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(READ_NUM_NODE),
            ...
            IF_ELSE_NODE(
                IS_THERE_SPACE_WITHIN_N_SPACES_OF_TARGET_THAT_SATISFIES_COND_NODE(2, predNode),
                15,
                7
            ),
        ),
...
// 🪓 Glacial Greataxe
{
    let skillId = Weapon.GlacialGreataxe;
    // Mt：11 Rng：1
    // Accelerates Special trigger (cooldown count-1).
    // Unit attacks twice
    // (even if foe initiates combat, unit attacks twice).
...
// 🅰️ Shatterproof
{
    let skillId = PassiveA.Shatterproof;
    // Grants Atk/Def+8. Inflicts Res-8.
    // At start of player phase or enemy phase,
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        // neutralizes [Panic]
        NEUTRALIZES_STATUS_EFFECT_ON_MAP_THAT_TAKE_EFFECT_ON_TARGET_AT_THAT_TIME_NODE(StatusEffectType.Panic),
        // and any penalties to unit’s Atk/Def
        NEUTRALIZES_PENALTIES_ON_MAP_THAT_TAKE_EFFECT_ON_TARGET_AT_THAT_TIME_NODE(true, false, true, false),
...
// 🅱️ Glacial Seal
{
    let skillId = PassiveB.GlacialSeal;
    // Enables [Canto (Rem. +1; Min 2)].
    enablesCantoRemPlusMin(skillId, 1, 2);
    // At start of player phase or enemy phase,
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
    ...
    setAtStartOfEnemyPhaseAfterHealingAndDamageSkillsExceptForInPawnsOfLoki(skillId, NODE_FUNC(
        // if unit’s HP ≥ 25%
        // after start-of-turn healing and damage effects are applied
        IF_NODE(IS_UNITS_HP_GTE_25_PERCENT_AT_START_OF_TURN_NODE,
            // and there is no [Divine Vein (Ice)] currently applied by unit or allies,
                ...
                FOR_EACH_UNIT_NODE(
                    ...
                    FOR_EACH_SPACES_NODE(
                        ...
                        UNLESS_NODE(
                            ...
                            APPLY_DIVINE_VEIN_NODE(DivineVeinType.Ice, SKILL_OWNER_GROUP_NODE, 1),
                        ),
                    ),
                ),
            ),
...
// 🗡 Scrolls of Time
{
    let skillId = Weapon.ScrollsOfTime;
    // Mt: 9 Rng: 2
    // Accelerates Special trigger
    // (cooldown count-1).
    // If unit initiates combat, unit attacks twice.
    // unit can move through foes’ spaces.
    UNIT_CAN_MOVE_THROUGH_FOES_SPACES_HOOKS.addSkill(skillId, () =>
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
            ...
            CACHE_NODE(`${skillId}_grants-stats`,
                MULT_ADD_MAX_NODE(
                    NUM_OF_TARGETS_ALLIES_NODE(
                        HAS_TARGET_STATUS_EFFECT_NODE(StatusEffectType.TimesGate),
                    ),
                    3, 5, 14,
                ),
            ),
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        [
            ...
            TARGETS_REST_WEAPON_SKILL_AVAILABLE_TURN_NODE(2,
                // grants another action to unit after combat, and
...
// TODO: 動作確認
{
    let skillId = Special.FutureAndPast;
    // SP: 4
    ...
    WHEN_APPLIES_SPECIAL_EFFECTS_AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        ...
        BOOSTS_DAMAGE_WHEN_SPECIAL_TRIGGERS_NODE(PERCENTAGE_NODE(80, UNITS_SPD_NODE)),
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        [
            ...
            IF_NODE(AND_NODE(IS_TARGETS_SPECIAL_TRIGGERED_NODE, IS_TARGET_ALIVE),
                ...
                GRANTS_ANOTHER_ACTION_AND_APPLIES_SKILL_NODE(
                    INFLICTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(StatusEffectType.Gravity),
                    // TODO: 実装する
                    // INFLICTS_STATUS_EFFECTS_ON_TARGETS_PAIR_ON_MAP_NODE(StatusEffectType.Gravity),
                ),
            ),
...
// 🐉 Conjuring Breath
{
    let skillId = PassiveB.ConjuringBreath;
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        // If unit initiates combat,
        DOES_UNIT_INITIATE_COMBAT_NODE,
        ...
        DEALS_DAMAGE_TO_FOE_AS_COMBAT_BEGINS_NODE(7),
        // and foe cannot recover HP during or after combat.
        FOR_FOE_NODE(TARGET_CANNOT_RECOVER_HP_NODE),
        // If unit initiates combat,
        ...
        [
            ...
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(
                PERCENTAGE_NODE(20, MAX_NODE(FOES_SPD_NODE, FOES_RES_NODE)),
            ),
            NON_STATS_SKILL_USING_STATS_HOOKS,
        ],
...
// 🟨 A/S Assault Hone
{
    let setSkill = (skillId, statsNode, grantsStatsNode) => {
        // At start of turn,
        AT_START_OF_TURN_HOOKS.addSkill(skillId, NODE_FUNC(
            // if unit is within 2 spaces of an ally,
            IF_NODE(IS_TARGET_WITHIN_2_SPACES_OF_TARGETS_ALLY_NODE,
        ...
        SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
            ...
            grantsStatsNode(
                ...
                ADD_MAX_NODE(
                    NUM_OF_TARGETS_ALLIES_NODE(
                        HAS_TARGET_STATUS_EFFECT_NODE(StatusEffectType.ReducesPercentageOfFoesNonSpecialReduceDamageSkillsBy50Percent),
                    ),
                    2,
                    5,
                ),
...
// 🟩 Duo Skill
{
    let skillId = getDuoOrHarmonizedSkillId(Hero.DuoGullveigNinja);
    ...
    CAN_TRIGGER_DUO_OR_HARMONIZED_EFFECT_HOOKS_MAP.addValue(Hero.DuoGullveigNinja,
...
// 0-n-忍の戦輪+
{
    let skillId = Weapon.RenNozhanLunPlus;
    // 威力：8 射程：1
    ...
    SkillEffectRegistrar.registerSelfTargetingSkills(skillId,
        ...
        GRANTS_ALL_STATS_PLUS_5_TO_TARGET_DURING_COMBAT_NODE,
        // 与えるダメージ＋15（範囲奥義を除く）、
        TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(15),
        // 受けるダメージ－10（範囲奥義を除く）、
...
{
    let skillId = PassiveB.AssuredRebirthPlus;
    // At start of player phase or enemy phase,
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        // inflicts Atk/Def/Res-7,
        // 【Frozen】, and【Sabotage】 on closest foes
        ...
        [
            ...
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_N_PERCENT_NODE(
                ...
                ENSURE_MAX_NODE(
                    ADD_NODE(
                        MULT_NODE(
                            // number of staff or dragon allies within 3 spaces of unit
                            NUM_OF_TARGETS_ALLIES_NODE(
                                AND_NODE(
                                    IS_TARGET_WITHIN_3_SPACES_OF_SKILL_OWNER_NODE,
                        ...
                        // and also, if unit's Res > foe's Res, difference between stats × 4 (max 40%;
                        ENSURE_MIN_MAX_NODE(MULT_NODE(DIFFERENCE_BETWEEN_RES_STATS_NODE, 4), 0, 40),
                    ),
                    // total max 60%).
                    60,
                ),
...
{
    let skillId = PassiveA.SwiftSlice2;
    // At start of player phase or enemy phase,
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        // if unit is within 2 spaces of an ally,
        IF_NODE(IS_TARGET_WITHIN_2_SPACES_OF_TARGETS_ALLY_NODE,
...

{
    ...
    AT_START_OF_ENEMY_PHASE_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        // at the start of enemy phase,
        // grants [Foresight Snare] to allies closest to the bottom of the map within 3 columns centered on unit for 1 turn.
        IF_ELSE_NODE(WHEN_DEFENDING_IN_AETHER_RAIDS_NODE,
            FOR_EACH_UNIT_NODE(
                MAX_UNITS_NODE(
                    FILTER_UNITS_NODE(
...
// Arcane Rexbolt
{
    let skillId = Weapon.ArcaneRexbolt;
    // Mt: 14 Rng: 2
    // Accelerates Special trigger
    // (cooldown count-1).
    // At start of player phase or enemy phase,
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            // (excluding area-of-effect Specials),
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(25),
            // reduces damage from foe’s attacks by 15
            // (excluding area-of-effect Specials),
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(15),
            // and reduces the percentage of foe’s
            // non-Special “reduce damage by X%” skills
            // by 50% during combat
            // (excluding area-of-effect Specials).
...
// Refined Magic
{
    let skillId = PassiveA.RefinedMagic;
        ...
        IF_NODE(IS_TARGET_WITHIN_2_SPACES_OF_TARGETS_ALLY_NODE,
            ...
            FOR_EACH_UNIT_NODE(
                ...
                IF_NODE(IS_TARGET_WITHIN_2_SPACES_OF_SKILL_OWNER_NODE,
                    ...
                    GRANTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(StatusEffectType.AssignDecoyTwin),
                ),
            ),
        ),
    ));
...
// [Assign Decoy Twin]
{
    let skillId = getStatusEffectSkillId(StatusEffectType.AssignDecoyTwin);
    ...
    IS_ASSIGN_DECOY_FOR_SAME_RANGE_ACTIVE_HOOKS.addSkill(skillId, () => TRUE_NODE);
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        ...
        IF_NODE(
            AND_NODE(
                EQ_NODE(FOES_RANGE_NODE, TARGETS_RANGE_NODE),
...
// Preempt: Ploy
{
    let skillId = PassiveC.PreemptPloy;
    // At start of player phase or enemy phase,
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        // if any foes within 3 rows or 3 columns centered on unit
        FOR_EACH_UNIT_NODE(
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        ...
        GRANTS_ATK_RES_TO_TARGET_DURING_COMBAT_NODE(
            CACHE_NODE(`${skillId}_grants-atk-res`,
    ...
    setCondHooks(skillId,
        ...
        [
            ...
            NODE_FUNC(
                X_NUM_NODE(
                    // unit deals +X damage
                    // (excluding area-of-effect Specials);
                    TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_PER_ATTACK_NODE(READ_NUM_NODE),
        ...
        [
            ...
            NODE_FUNC(
                ...
                // excluding Røkkr area-of-effect Specials),
                REDUCES_DAMAGE_FROM_FOES_SPECIALS_BY_X_EXCLUDING_AOE_SPECIAL_NODE(PERCENTAGE_NODE(20, UNITS_SPD_NODE)),
            ),
        ],
        [
            BEFORE_AOE_SPECIAL_HOOKS,
        ...
        [
            ...
            NODE_FUNC(
                ...
                TRIGGERS_TARGETS_POTENT_FOLLOW_X_DURING_COMBAT_NODE(100, 10),
            ),
        ],
        [
            // If foe initiates combat
...
// Harrowing Call
{
    let skillId = PassiveB.HarrowingCall;
    ...
    DOES_UNIT_MOVE_1_SPACE_AWAY_AFTER_COMBAT_HOOKS.addSkill(skillId, () => TRUE_NODE);
}

// Bonded Blades
{
    let skillId = Weapon.BondedBlades;
    // Mt: 11 Rng: 1
    // Grants Atk+3.
    // Unit attacks twice (even if foe initiates combat).
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(TARGET_ATTACKS_TWICE_EVEN_IF_TARGETS_FOE_INITIATES_COMBAT_NODE));
    BEFORE_AOE_SPECIAL_ACTIVATION_CHECK_HOOKS.addSkill(skillId, NODE_FUNC(
...
// Ties of Crimea
{
    let skillId = PassiveC.TiesOfCrimea;
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        ...
        IF_NODE(IS_TARGET_WITHIN_3_SPACES_OF_TARGETS_ALLY_NODE,
            ...
            // reduces damage from foe’s attacks by 7
            // (excluding area-of-effect Specials),
            REDUCES_DAMAGE_FROM_FOES_SPECIALS_BY_X_EXCLUDING_AOE_SPECIAL_NODE(7),
            // neutralizes effects that guarantee foe’s follow-up attacks
            NEUTRALIZES_EFFECTS_THAT_GUARANTEE_TARGETS_FOES_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE,
            // and effects that prevent unit’s follow-up attacks,
            NEUTRALIZES_EFFECTS_THAT_PREVENT_TARGETS_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE,
...
// Duo Skill
{
    let skillId = getDuoOrHarmonizedSkillId(Hero.DuoElincia);
    WHEN_TRIGGERS_DUO_OR_HARMONIZED_EFFECT_HOOKS.addSkill(skillId, NODE_FUNC(
        // Grants [Bulwark]
        // to unit and allies within 2 spaces of unit for 1 turn.
        GRANTS_STATUS_EFFECTS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_2_SPACES_NODE(
        ...
        FOR_EACH_SPACES_NODE(
            ...
            SPACES_WITHIN_N_SPACES_OF_TARGET_NODE(2),
...
// Assault Impetus
{
    let skillId = PassiveB.AssaultImpetus;
    setCondHooks(skillId,
        // If unit initiates combat or is within 2 spaces of an ally,
        OR_NODE(DOES_UNIT_INITIATE_COMBAT_NODE, IS_TARGET_WITHIN_2_SPACES_OF_TARGETS_ALLY_NODE),
        [
        ...
        [
            NON_STATS_SKILL_USING_STATS_HOOKS,
            NODE_FUNC(
                // deals damage = 20% of the greater
    ...
    setCondHooks(skillId,
        ...
        AND_NODE(DOES_UNIT_INITIATE_COMBAT_NODE, IF_UNIT_OR_FOE_INITIATES_COMBAT_AFTER_MOVING_TO_A_DIFFERENT_SPACE_NODE),
        // triggers the following effects depending on unit’s equipped Special:
        [
            BEFORE_COMBAT_HOOKS,
            NODE_FUNC(
                // if unit has an area-of-effect Special equipped,
                IF_NODE(HAS_TARGET_AOE_SPECIAL_NODE,
                    X_NUM_NODE(
        ...
        [
            ...
            NODE_FUNC(
                ...
                // (excluding area-of-effect Specials),
                IF_NODE(HAS_TARGET_SPECIAL_THAT_TRIGGERS_WHEN_UNIT_ATTACKS_EXCLUDING_AOE_SPECIALS_NODE,
                    X_NUM_NODE(
...
// Entwined Onrush
{
    let skillId = PassiveC.EntwinedOnrush;
    ...
    AFTER_ALLIES_COMBAT_FOR_ANOTHER_ACTION_HOOKS.addSkill(skillId, NODE_FUNC(
        // if support partner or an ally within 3 spaces of unit initiates combat,
        IF_NODE(
            AND_NODE(
                OR_NODE(
                    FOR_TARGET_NODE(TARGETS_ALLY_NODE, ARE_TARGET_AND_SKILL_OWNER_PARTNERS_NODE),
            ...
            // (once per turn; if another effect that grants
...

{
    ...
    AT_START_OF_TURN_HOOKS.addSkill(skillId, NODE_FUNC(
        ...
        IF_NODE(
            LTE_NODE(CURRENT_TURN_NODE, 3),
            FOR_EACH_UNIT_NODE(
                FILTER_UNITS_NODE(UNITS_ON_MAP_NODE, IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE),
                DEALS_DAMAGE_TO_TARGET_ON_MAP_NODE(10),
            ),
        ),
    ));
    setForFoesSkillsDuringCombatHooks(skillId,
        // 自身を中心とした縦3列と横3列の敵は戦闘中、
        IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE,
        SKILL_EFFECT_NODE(
            // 攻撃、守備ー5、
        ...
        SKILL_EFFECT_NODE(
            ...
            UNIT_MAKES_GUARANTEED_FOLLOW_UP_ATTACK_NODE,
            // 戦闘相手から受けた攻撃のダメージ+
            // その敵と戦闘相手の戦闘開始時のHP減少量の高い方の値
            // （範囲奥義を除く、巨影のHP減少量は除く）
            UNIT_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(
                MAX_NODE(
                    FOR_UNIT_DURING_COMBAT_NODE(SUB_NODE(TARGETS_MAX_HP_NODE, TARGETS_HP_AT_START_OF_COMBAT_NODE)),
                    FOR_FOE_NODE(SUB_NODE(TARGETS_MAX_HP_NODE, TARGETS_HP_AT_START_OF_COMBAT_NODE)),
                ),
            ),
        ),
    );
    setCondHooks(skillId,
        ...
        [
            AT_START_OF_COMBAT_HOOKS,
            NODE_FUNC(
                // 戦闘中、敵の攻撃、守備が戦闘開始時の自分の守備の20%だけ減少、
                INFLICTS_ATK_DEF_ON_FOE_DURING_COMBAT_NODE(
                    PERCENTAGE_NODE(20, UNITS_DEF_AT_START_OF_COMBAT_NODE),
                ),
            ),
        ],
        [
            NON_STATS_SKILL_USING_STATS_HOOKS,
            NODE_FUNC(
                // 自分が与えるダメージ＋守備の20%（範囲奥義を含む）、
                DEALS_DAMAGE_X_NODE(PERCENTAGE_NODE(20, UNITS_DEF_NODE)),
                // 自分が受けるダメージー守備の20%（範囲奥義を除く）
...

{
    ...
    setForAlliesHooks(skillId,
        ...
        GRANTS_ATK_SPD_TO_TARGET_DURING_COMBAT_NODE(5),
        SKILL_EFFECT_NODE(
            // 与えるダメージ＋7（範囲奥義を除く）、受けるダメージー7（範囲奥義を除く）、
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(7),
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(7),
            // 自身の奥義発動カウント変動量ーを無効
    ...
    setCondHooks(skillId,
        ...
        [
            AT_START_OF_COMBAT_HOOKS,
            NODE_FUNC(
                // 戦闘中、攻撃、速さ、守備、魔防が自身を中心とした縦3列と横3列にいる味方の数x3＋5だけ増加（最大14）、
                GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
                    MULT_ADD_MAX_NODE(NUM_OF_ALLIES_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_UNIT_NODE, 3, 5, 14),
                ),
            ),
        ...
        [
            WHEN_APPLIES_POTENT_EFFECTS_HOOKS,
            // かつ追撃の速さ条件を－25した状態で追撃の速さ条件を満たしている時（絶対追撃、追撃不可は含まない）、
            // 戦闘中、【神速追撃：ダメージ〇%】を発動（〇は、自分が2回攻撃でない、かつ追撃ができない時は80、それ以外は40）
            NODE_FUNC(
...
{
    let skillId = Weapon.SaintshipTome;
    // For allies within 3 rows or 3 columns centered on unit,
    // grants Atk/Res+5 and
    // neutralizes foe's bonuses during combat, and
    // restores 7 HP after their combat.
    setForAlliesHooks(skillId,
        IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE,
        GRANTS_ATK_RES_TO_TARGET_DURING_COMBAT_NODE(5),
        SKILL_EFFECT_NODE(
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_NODE(IS_TARGET_WITHIN_3_SPACES_OF_TARGETS_ALLY_NODE,
            ...
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(7),
            // unit makes a guaranteed follow-up attack during combat, and
            UNIT_MAKES_GUARANTEED_FOLLOW_UP_ATTACK_NODE,
            // restores 7 HP to unit after combat.
            RESTORES_7_HP_TO_TARGET_AFTER_COMBAT_NODE,
        ),
...
{
    let skillId = getSpecialRefinementSkillId(Weapon.SaintshipTome);
    // At start of combat,
    // if unit's HP ≥ 25%,
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        IS_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE,
...
// Glee of the Land
{
    let skillId = Weapon.GleeOfTheLand;
    // Mt: 14 Rng: 1
    // Grants Spd+3.
    // For allies within 3 rows or 3 columns centered on unit,
    setForAlliesHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            IF_NODE(HAS_TARGET_SPECIAL_NODE(),
    ...
    let xNode =
        ...
        ENSURE_MAX_NODE(
            COND_OP(
                ...
                MULT_NODE(TARGETS_MAX_SPECIAL_COUNT_NODE, 40),
                MULT_NODE(TARGETS_MAX_SPECIAL_COUNT_NODE, 20),
            ),
            100,
        );
    FOR_ALLIES_WHEN_APPLIES_POTENT_EFFECTS_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        IF_NODE(IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE,
            ...
            IF_NODE(HAS_TARGET_SPECIAL_NODE(),
                ...
                TRIGGERS_TARGETS_POTENT_FOLLOW_X_DURING_COMBAT_NODE(xNode, 25),
            ),
        ),
    ));
    setCondHooks(skillId,
        ...
        [
            ...
            NODE_FUNC(
                ...
                IF_NODE(HAS_TARGET_SPECIAL_NODE(),
                    ...
                    // (excluding area-of-effect Specials),
                    DEALS_DAMAGE_X_NODE(MULT_NODE(TARGETS_MAX_SPECIAL_COUNT_NODE, 5)),
                    // reduces damage from foe's attacks by
                    // unit's max Special cooldown count value × 3
                    // (excluding area-of-effect Specials),
                    REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(
                        MULT_NODE(TARGETS_MAX_SPECIAL_COUNT_NODE, 3),
                    ),
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        ...
        IF_NODE(
            ...
            RESTORES_N_HP_TO_UNIT_AFTER_COMBAT_NODE(MULT_NODE(TARGETS_MAX_SPECIAL_COUNT_NODE, 3)),
        )
    ));
    // At start of turn,
    // if unit is adjacent to only beast or dragon allies
...
// Moonlit Slumber
{
    let skillId = PassiveB.MoonlitSlumber;
    // Enables [Canto (Rem. +1; Min 2)].
    enablesCantoRemPlusMin(skillId, 1, 2);
...
// A/S Bellow
{
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        GRANTS_ATK_SPD_TO_TARGET_DURING_COMBAT_NODE(
            CACHE_NODE(`${skillId}-grants-atk-spd`,
                ...
                ADD_MAX_NODE(
                    ...
                    NUM_OF_UNITS_WITH(
                        TARGETS_ALLIES_ON_MAP_NODE,
                        HAS_TARGET_STATUS_EFFECT_NODE(StatusEffectType.SpecialCooldownChargePlusOnePerAttack)
                    ),
                    5,
                ),
            ),
        ...
        TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(
            MULT_MAX_NODE(NUMBER_OF_SPACES_FROM_START_POSITION_TO_END_POSITION_OF_WHOEVER_INITIATED_COMBAT, 2, 8),
        ),
    ));
}
...
// Spooky Lantern
{
    let skillId = Weapon.SpookyLantern;
    // Mt: 14 Rng: 2
    // Enables [Canto (Rem.; Min 1)].
    enablesCantoRemPlusMin(skillId, 0, 1);
    // Grants Spd+3.
    ...
    setForAlliesHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(10),
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_NODE(IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE,
            ...
            GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
                ...
                CACHE_NODE(`${skillId}-grants-bonus`,
                    MULT_ADD_MAX_NODE(NUM_OF_ALLIES_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_UNIT_NODE, 3, 5, 14),
                ),
            ),
...
// Pleasant Night
{
    let skillId = Support.PleasantNight;
    // Rng: 1
    setRefresh(skillId);
    ...
    AFTER_REFRESH_SKILL_IS_USED_BY_UNIT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        FOR_EACH_UNIT_NODE(
            FILTER_UNITS_NODE(
                ...
                OR_NODE(
                    IS_TARGET_IN_CARDINAL_DIRECTIONS_OF_UNIT_NODE(ASSIST_TARGETING_NODE),
                    IS_TARGET_IN_CARDINAL_DIRECTIONS_OF_UNIT_NODE(ASSIST_TARGET_NODE),
                ),
            ),
            // Grants Atk/Spd/Def/Res+5,
            GRANTS_ALL_BONUSES_TO_TARGET_ON_MAP_NODE(5),
            // [Reflex], and [Empathy]
            GRANTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(StatusEffectType.Reflex, StatusEffectType.Empathy),
...
// B D/R Cantrip 3
{
    let skillId = PassiveB.DRCantrip3;
...
// Shadow Shove 4
{
    let skillId = PassiveC.ShadowShove4;
    // When Canto triggers,
    WHEN_CANTO_TRIGGERS_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // enables unit to use [Shove] on ally
        // (this effect is not treated as an Assist skill;
        // if similar effects are active, this effect does not trigger).
        ENABLES_TARGET_TO_USE_CANTO_ASSIST_ON_TARGETS_ALLY_NODE(AssistType.Move, CantoSupport.Shove, 1)),
    );
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // If unit is within 3 spaces of an ally,
        IF_NODE(IS_TARGET_WITHIN_3_SPACES_OF_TARGETS_ALLY_NODE,
...
// Preying Fang
{
    let skillId = Weapon.PreyingFang;
    // Mt: 14 Rng: 1
    // Accelerates Special trigger (cooldown count-1).
        ...
        GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
            ...
            CACHE_NODE(`${skillId}-grants-bonus`,
                IF_ELSE_NODE(
                    ...
                    14,
                    MULT_ADD_MAX_NODE(
                        NUM_OF_FOES_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_UNIT_NODE, 3, 5, 14
                    ),
                ),
            ),
        ),
...
// Nightmare Staff
{
    let skillId = Weapon.NightmareStaff;
    // Rng: 2
    // Accelerates Special trigger (cooldown count-1).
    // At start of turn,
    AT_START_OF_TURN_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            GRANTS_ATK_TO_TARGET_DURING_COMBAT_NODE(MULT_NODE(TARGETS_MAX_SPECIAL_COUNT_NODE, 4)),
        ),
        SKILL_EFFECT_NODE(
...
// Comet
{
    ...
    WHEN_APPLIES_SPECIAL_EFFECTS_AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        BOOST_DAMAGE_DEALT_BY_X_PERCENT_NODE(200),
    ));
    // At start of turn,
    AT_START_OF_TURN_HOOKS.addSkill(skillId, NODE_FUNC(
        // grants Special cooldown count-1 to unit.
...
// Haunting Choker
{
    let skillId = PassiveB.HauntingChoker;
    // For foes within 3 rows or 3 columns centered on unit,
    setForFoesSkillsDuringCombatHooks(skillId,
        IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE,
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        ...
        IF_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE(
            X_NUM_NODE(
                ...
                INFLICTS_SPD_RES_ON_FOE_DURING_COMBAT_NODE(MULT_NODE(4, READ_NUM_NODE)),
                // neutralizes effects that guarantee foe's follow-up attacks and
                NEUTRALIZES_EFFECTS_THAT_GUARANTEE_TARGETS_FOES_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE,
                // effects that prevent unit's follow-up attacks,
                NEUTRALIZES_EFFECTS_THAT_PREVENT_TARGETS_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE,
...
// Duo Skill
{
    let skillId = getDuoOrHarmonizedSkillId(Hero.DuoFreyja);
    WHEN_TRIGGERS_DUO_OR_HARMONIZED_EFFECT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        FOR_EACH_UNIT_NODE(
            FILTER_UNITS_NODE(
                TARGETS_FOES_ON_MAP_NODE,
                IS_TARGET_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE(5),
            ),
            ...
            INFLICTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(StatusEffectType.Frozen, StatusEffectType.Discord),
...
{
    let skillId = PassiveA.DualityPlus;
    // ターン開始時、自分と周囲2マス以内の味方の奥義発動カウントー 1
    AT_START_OF_TURN_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        FOR_EACH_TARGET_AND_TARGETS_ALLY_WITHIN_2_SPACES_OF_TARGET_NODE(
            GRANTS_SPECIAL_COOLDOWN_COUNT_MINUS_ON_TARGET_ON_MAP_NODE(1),
        ),
    ));
    // 赤属性、青属性、緑属性の敵と戦闘時、自分は3すくみ有利、敵は3すくみ不利となる
    CALC_TRIANGLE_ADVANTAGE_HOOKS.addSkill(skillId, () => SUM_NODE(
        IF_ELSE_NODE(
            FOR_TARGETS_FOE_NODE(
                OR_NODE(
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // 自分と敵の3すくみが有利だと、さらに有利になる効果と3すくみが不利だと、さらに不利になる効果を無効（相性激化を無効）
        FOR_EACH_UNIT_NODE(TARGET_AND_TARGET_FOE_NODE,
            NEUTRALIZES_TARGETS_EFFECTS_THAT_BOOST_VALUES_ALONG_WITH_WEAPON_TRIANGLE_ADVANTAGE_NODE,
            NEUTRALIZES_TARGETS_EFFECTS_THAT_REDUCE_VALUES_ALONG_WITH_WEAPON_TRIANGLE_DISADVANTAGE_NODE,
        ),
        // 戦闘中、絶対追撃、与えるダメージ+7（範囲奥義を含む（巨影の範囲奥義は除く））、受けるダメージー7（範囲奥義を除く）
        UNIT_MAKES_GUARANTEED_FOLLOW_UP_ATTACK_NODE,
...
}
{
    ...
    // If Sing or Dance is used,
    AFTER_REFRESH_SKILL_IS_USED_BY_UNIT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // inflicts Def/Res-7, (Exposure), and (Panic)
        // on closest foes to unit and target ally
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        IF_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE(
            // grants bonus to unit's Atk/Spd =
            GRANTS_ATK_SPD_TO_TARGET_DURING_COMBAT_NODE(
                CACHE_NODE(`${skillId}_grants-atk-spd`,
                    // 6 + 10% of unit's Spd at start of combat and
                    ADD_NODE(6, PERCENTAGE_NODE(10, UNITS_SPD_AT_START_OF_COMBAT_NODE)),
                ),
            ),
            // neutralizes effects that guarantee foe's follow-up attacks
            NEUTRALIZES_EFFECTS_THAT_GUARANTEE_TARGETS_FOES_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE,
            // and effects that prevent unit's follow-up attacks during combat, and also,
            NEUTRALIZES_EFFECTS_THAT_PREVENT_TARGETS_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE,
            // if unit has weapon-triangle advantage
            // or Penalty is active on foe,
            IF_NODE(OR_NODE(HAS_TARGET_WEAPON_TRIANGLE_ADVANTAGE_NODE, IS_PENALTY_ACTIVE_ON_FOE_NODE),
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        IF_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE(
            ...
            X_NUM_NODE(
                ...
                TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(MULT_MAX_NODE(READ_NUM_NODE, 5, 25)),
                // X = number of Bonus effects active on unit,
                // excluding stat bonuses + number of Penalty effects
                // active on foe, excluding stat penalties), and
...
{
    let skillId = Support.Dragonsdance2;
    // 対象を行動可能な状態にし、
    // 対象が再移動を発動済みなら再発動可能にする、
    setRefresh(skillId);
    AFTER_REFRESH_SKILL_IS_USED_BY_UNIT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // かつ対象と、自分とダブル相手の攻撃、速さ＋6、
        // 【強化ダメージ＋】、【神速追撃】を付与（1ターン）、
        FOR_EACH_UNIT_NODE(ASSIST_TARGETING_AND_TARGET_NODE,
            GRANTS_ATK_SPD_TO_TARGET_ON_MAP_NODE(6),
            GRANTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(StatusEffectType.Treachery, StatusEffectType.PotentFollow),
        ),
    ));
    // 2ターン目以降なら、
    // その後、自分を行動可能にする、かつ自分とダブル相手に【補助不可】を付与（次回行動終了まで）
    // （「その後」以降の効果は、その効果が発動後2ターンの間発動しない）
    AFTER_REFRESH_ENDED_BY_UNIT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
...
}
{
    ...
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        FOR_EACH_UNIT_NODE(
            ...
            IF_NODE(LT_NODE(TARGETS_EVAL_RES_NODE, ADD_NODE(SKILL_OWNERS_EVAL_RES_ON_MAP, 5)),
                // inflicts [Guard], [Discord], and [Res Shackle]
                INFLICTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(
                    StatusEffectType.Guard, StatusEffectType.Discord, StatusEffectType.ResShackle
                ),
            ),
            // on foes within 3 rows or 3 columns centered on unit
            // with Res < unit's Res + 5
            // through their next actions.
        )
    ));
    setCondHooks(skillId,
        ...
        [
            ...
            NODE_FUNC(
                GRANTS_ALL_STATS_PLUS_5_TO_TARGET_DURING_COMBAT_NODE,
                // foe cannot make a follow-up attack, and
                FOE_CANNOT_MAKE_FOLLOW_UP_ATTACK_NODE,
                // neutralizes effects that grant "Special cooldown charge +X" to foe during combat.
                NEUTRALIZES_EFFECTS_THAT_GRANT_SPECIAL_COOLDOWN_CHARGE_PLUS_X_TO_FOE,
            ),
        ],
        // deals damage = 20% of unit's Res
...
}
{
    ...
    setCondHooks(skillId,
        ...
        [
            ...
            NODE_FUNC(
                // grants bonus to unit's Atk/Spd/Def/Res =
                // 5 + 10% of unit's Res at start of combat,
                GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
                    CACHE_NODE(`${skillId}_grants-stats`,
                        ADD_NODE(5, PERCENTAGE_NODE(10, UNITS_RES_AT_START_OF_COMBAT_NODE)),
                    ),
                )
            ),
        ],
...
}
{
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        // If unit initiates combat or foe's HP ≥ 50%
        OR_NODE(DOES_UNIT_INITIATE_COMBAT_NODE, IS_FOES_HP_GTE_50_PERCENT_AT_START_OF_COMBAT_NODE),
        // at start of combat, grants Atk/Spd+6 and
        SKILL_EFFECT_NODE(
            GRANTS_ATK_SPD_TO_TARGET_DURING_COMBAT_NODE(6),
            // Def/Res+5,
            GRANTS_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(5),
...
}
{
    ...
    setForAlliesHooks(skillId,
        IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE,
        // grants Atk/Spd+5 and
        GRANTS_ATK_SPD_TO_TARGET_DURING_COMBAT_NODE(5),
        SKILL_EFFECT_NODE(
            // Special cooldown count-1 to ally
            // before ally's first attack during combat,
            GRANTS_SPECIAL_COOLDOWN_COUNT_MINUS_N_TO_TARGET_BEFORE_TARGETS_FIRST_ATTACK_DURING_COMBAT_NODE(1),
            // and also, if ally initiates combat and foe's attack can
            // trigger foe's Special,
            IF_NODE(
                AND_NODE(DOES_TARGET_INITIATE_COMBAT_NODE, CAN_TARGETS_FOES_ATTACK_TRIGGER_TARGETS_FOES_SPECIAL_NODE),
                // inflicts Special cooldown count+1 on foe
                // before foe's first attack during combat
                // (cannot exceed foe's maximum Special cooldown).
                INFLICTS_SPECIAL_COOLDOWN_COUNT_PLUS_N_ON_TARGETS_FOE_BEFORE_TARGETS_FOES_FIRST_ATTACK_NODE(1),
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_NODE(OR_NODE(DOES_UNIT_INITIATE_COMBAT_NODE, IS_FOES_HP_GTE_50_PERCENT_AT_START_OF_COMBAT_NODE),
            // grants bonus to unit's Atk/Spd/Def/Res = number of allies
            GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
                // within 3 rows or 3 columns centered on unit x 2, + 5 (max 11),
                MULT_ADD_MAX_NODE(NUM_OF_ALLIES_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_UNIT_NODE, 2, 5, 11),
            ),
            // neutralizes foe's bonuses to Spd/Def,
            NEUTRALIZES_FOES_EACH_BONUSES_TO_STATS_DURING_COMBAT_NODE(false, true, true, false),
            // reduces damage from foe's attacks by 7
            ...
            // before unit's first attack during combat,
            GRANTS_SPECIAL_COOLDOWN_COUNT_MINUS_N_TO_TARGET_BEFORE_TARGETS_FIRST_ATTACK_DURING_COMBAT_NODE(1),
            // and also, if unit initiates combat and foe's attack can trigger foe's Special,
            IF_NODE(AND_NODE(DOES_UNIT_INITIATE_COMBAT_NODE, CAN_TARGETS_FOES_ATTACK_TRIGGER_TARGETS_FOES_SPECIAL_NODE),
                // inflicts Special cooldown count+1 on foe
                // before foe's first attack during combat
                // (cannot exceed foe's maximum Special cooldown).
                INFLICTS_SPECIAL_COOLDOWN_COUNT_PLUS_N_ON_TARGETS_FOE_BEFORE_TARGETS_FOES_FIRST_ATTACK_NODE(1),
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            IF_NODE(GT_NODE(UNITS_EVAL_SPD_NODE, FOES_EVAL_SPD_NODE),
                ...
                // (excluding Rokkr area-of-effect Specials)
                REDUCES_DAMAGE_BY_X_PERCENT_NODE(
                    // by percentage = difference between stats × 4 (max 40%).
                    ENSURE_MIN_MAX_NODE(MULT_TRUNC_NODE(SPD_DIFF_NODE, 4), 0, 40),
                )
            ),
            // and reduces damage by 20% of unit's Spd during combat
            // (excluding area-of-effect Specials).
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(
                PERCENTAGE_NODE(20, UNITS_SPD_NODE),
            ),
...
}
{
    ...
    // At start of player phase or enemy phase
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        // grants "neutralizes penalties on unit during combat" and [Null Follow-Up]
        // to unit and allies within 2 spaces of unit for 1 turn.
        GRANTS_STATUS_EFFECTS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_2_SPACES_NODE(
            StatusEffectType.NeutralizesPenalties,
            StatusEffectType.NullFollowUp,
    ...
    setAtStartOfEnemyPhaseExceptForInPawnsOfLoki(skillId, NODE_FUNC(
        // applies [Divine Vein(Flame)] to unit's space and spaces within 2spaces of unit for 1 turn.
        FOR_EACH_SPACES_NODE(
            SPACES_WITHIN_N_SPACES_OF_TARGET_NODE(2),
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        GRANTS_ALL_STATS_PLUS_5_TO_TARGET_DURING_COMBAT_NODE,
        SKILL_EFFECT_NODE(
            // unit deals damage = 20% of unit's Spd
            // (excluding area-of-effect Specials),
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(PERCENTAGE_NODE(20, UNITS_SPD_NODE)),
            // and restores 7 HP to unit when unit deals damage to foe during combat.
            WHEN_TARGET_DEALS_DAMAGE_DURING_COMBAT_RESTORES_N_HP_TO_TARGET_NODE(7),
        ),
    );
}
...
}
{
    ...
    // Grants Atk+3.
    let condKey = `${skillId}_錬成シャールヴィの4マス以内条件`;
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // If unit is within 4 spaces of an ally,
        IF_NODE(IS_TARGET_WITHIN_4_SPACES_OF_TARGETS_ALLY_NODE,
            // grants bonus to unit's Atk/Spd/Def/Res =
            GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
                // 8 + 10% of nearest ally's stat values
                ADD_N_TO_M_PERCENT_OF_STATS_NODE(8, 10,
                    MAX_STATS_NODE(
                        MAP_UNITS_NODE(
                ...
                // (calculates each stat bonus independently at start of combat;
                // if multiple allies meet the above conditions, only highest value applied),
            ),
            // unit deals +20 damage (excluding area-of-effect Specials),
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(20),
            // unit makes a guaranteed follow-up attack,
            UNIT_MAKES_GUARANTEED_FOLLOW_UP_ATTACK_NODE,
            // and reduces the percentage of foe's non-Special
            // "reduce damage by X%" skills by 50% during combat
            // (excluding area-of-effect Specials),
            REDUCES_PERCENTAGE_OF_TARGETS_FOES_NON_SPECIAL_DAMAGE_REDUCTION_BY_50_PERCENT_DURING_COMBAT_NODE,
            // but after combat, if unit attacked,
            TARGET_SATISFIED_CONDITION_DURING_COMBAT_NODE(condKey),
        ),
    ));
    AFTER_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
...
}
{
    ...
    // (if Canto triggers, after Canto),
    setAtStartOfTurnAndAfterUnitActsIfCantoAfterCanto(skillId, NODE_FUNC(
        // inflicts Spd/Res-7, [Frozen], and [Exposure]
        // on closest foes and any foes within 2 spaces of those foes
        // through their next actions.
        INFLICTS_STATS_PENALTIES_AND_STATUS_EFFECT_ON_MAP_ON_TARGETS_CLOSEST_FOE_AND_FOES_WITHIN_2_SPACES_NODE(
            SPD_RES_NODE(7),
...
}
{
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            NEUTRALIZES_EACH_PENALTIES_ON_TARGETS_NODE(true, true, false, false),
            // neutralizes effects that inflict
            // "Special cooldown charge -X" on unit during combat, and
            NEUTRALIZES_EFFECTS_THAT_INFLICT_SPECIAL_COOLDOWN_CHARGE_MINUS_X_ON_UNIT,
        ),
...
}
{
    ...
    AT_START_OF_TURN_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        IF_NODE(IS_TARGET_WITHIN_2_SPACES_OF_TARGETS_ALLY_NODE,
            // if unit is within 2 spaces of an ally,
            // grants Atk/Spd+6, [Desperation], and
            // "Special cooldown charge +1 per attack during combat
            // (only highest value applied; does not stack)"
            // to unit and allies within 2 spaces of unit for 1 turn.
            GRANTS_STATS_BONUS_AND_STATUS_EFFECTS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_2_SPACES_NODE(
...
// Sword of Fate
{
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            // (excluding area-of-effect Specials),
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(PERCENTAGE_NODE(20, UNITS_RES_NODE)),
            // reduces damage from foe’s Specials
            // by an additional 20% of unit’s Res
            // (excluding area-of-effect Specials), and
            REDUCES_DAMAGE_FROM_FOES_SPECIALS_BY_X_EXCLUDING_AOE_SPECIAL_NODE(PERCENTAGE_NODE(20, UNITS_RES_NODE)),
            // neutralizes effects that guarantee foe’s follow-up attacks
            NEUTRALIZES_EFFECTS_THAT_GUARANTEE_TARGETS_FOES_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE,
            // and effects that prevent unit’s follow-up attacks during combat.
            NEUTRALIZES_EFFECTS_THAT_PREVENT_TARGETS_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE,
...
// Torrential Roar
{
    ...
    NON_STATS_SKILL_USING_STATS_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_NODE(GT_NODE(UNITS_RES_NODE, FOES_RES_NODE),
            X_NUM_NODE(
    ...
    let targetAndCertainAlliesWithin2SpaceNode =
        CACHE_NODE(`${skillId}_target-and-certain-allies`,
            UNITE_UNITS_NODE(
                SKILL_OWNER_NODE,
                FILTER_UNITS_NODE(certainTargetNode, IS_TARGET_WITHIN_2_SPACES_OF_SKILL_OWNER_NODE)
            ));
    ...
    let targetUnitsSpacesOfIcicleNode =
        // ターゲットから2マス離れたマス - 氷を置いてはいけないマス(本人と対象の味方の1マス以内)
        DIFFERENCE_SPACES_NODE(
            SPACES_N_SPACES_AWAY_FROM_TARGET_NODE(2),
            FLAT_MAP_UNITS_NODE(
                targetAndCertainAlliesWithin2SpaceNode,
                SPACES_WITHIN_N_SPACES_OF_TARGET_NODE(1)
            ),
        );
...
{
    let skillId = getDivineVeinSkillId(DivineVeinType.Vert);
    // [Divine Vein (Vert)]
    ...
    CAN_INFLICT_CANTO_CONTROL_HOOKS.addSkill(skillId, () =>
        IS_TARGET_ON_DIVINE_VEIN_NODE(DivineVeinType.Vert, TARGET_FOE_GROUP_NODE)
    );
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
...
// Pair Up 4
{
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_NODE(IS_TARGET_WITHIN_3_SPACES_OF_TARGETS_ALLY_NODE,
            ...
            UNIT_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(15),
...
// Emblem Effect
{
    let skillId = getEmblemHeroSkillId(EmblemHero.Corrin);
        ...
        IF_NODE(IS_THERE_NO_DIVINE_VEIN_CURRENTLY_APPLIED_BY_TARGET_OR_TARGETS_ALLIES_NODE(DivineVeinType.Icicle),
            ...
            FOR_EACH_SPACES_NODE(
                DIFFERENCE_SPACES_NODE(
                    ...
                    READ_CACHE_NODE(`${skillId}_icicle-spaces`),
                ),
...
// Winds of Duality
{
    let skillId = Weapon.WindsOfDuality;
    // Mt: 14 Rng: 1 Eff: 🪶
    // Accelerates Special trigger (cooldown count-1).
    // Effective against flying foes.
    //
...
{
    let skillId = PassiveA.RejectTyranny;
    ...
    AT_START_OF_TURN_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_UNITS_HP_GTE_25_PERCENT_AT_START_OF_TURN_NODE(
            ...
            FOR_EACH_UNIT_NODE(
                UNITE_UNITS_NODE(
                    SKILL_OWNER_NODE,
                    FILTER_UNITS_NODE(TARGETS_ALLIES_WITHIN_2_SPACES_NODE(), IS_SWORD_LANCE_AXE_DRAGON_OR_BEAST_NODE),
                ),
                // and grants [Range: 2 Style] to unit and sword, lance, axe, dragon, or beast allies
                GRANTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(StatusEffectType.Range2Style),
                // within 2 spaces of unit for 1 turn.
            ),
        ),
    ));
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_NODE(OR_NODE(IS_TARGET_TRANSFORMED_NODE, IS_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE),
            ...
            X_NUM_NODE(
                ...
                REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(
                    MULT_NODE(READ_NUM_NODE, 4)
                ),
                // reduces damage from foe’s Specials by an additional X × 4
                // (excluding area-of-effect Specials;
                REDUCES_DAMAGE_FROM_FOES_SPECIALS_BY_X_EXCLUDING_AOE_SPECIAL_NODE(MULT_NODE(READ_NUM_NODE, 4)),
...
{
    let skillId = PassiveC.DarkBeastForce;
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // Inflicts Spd/Def-4 on foe,
        INFLICTS_SPD_DEF_ON_FOE_DURING_COMBAT_NODE(4),
...
// Hoshido Raijinto
{
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            DEALS_DAMAGE_WHEN_TRIGGERING_SPECIAL_DURING_COMBAT_NODE(PERCENTAGE_NODE(40, UNITS_SPD_NODE)),
        ),
    );
    // Unit can use the following [Style]:
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_UNIT_INITIATES_COMBAT_OR_IS_WITHIN_3_SPACES_OF_AN_ALLY(
            ...
            X_NUM_NODE(
                ...
                COND_OP(DOES_UNIT_INITIATE_COMBAT_NODE, 15, 7),
            ),
...
// Tumultuous Echo
{
    let skillId = PassiveX.TumultuousEcho;
    // Enables [Canto (Dist. +1; Max 4)].
    enablesCantoDist(skillId, 1, 4);
...
// Arcane Crimson
{
    let skillId = Weapon.ArcaneCrimson;
    // Mt: 16 Rng: 1
    // Accelerates Special trigger (cooldown count-1).
    ...
    setCondHooks(skillId,
        ...
        [
            AT_START_OF_COMBAT_HOOKS,
            NODE_FUNC(
                // grants bonus to unit’s Atk/Spd/Def/Res = 25% of foe’s Atk at start of combat - 9 (max 9; min 0),
                GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
                    ENSURE_MAX_MIN_NODE(PERCENTAGE_SUB_NODE(25, FOES_ATK_AT_START_OF_COMBAT_NODE, 9), 9, 0),
                ),
            ),
        ],
        [
...
// Air Superiority
{
    let skillId = PassiveB.AirSuperiority;
    // Unit can move through foes’ spaces.
    UNIT_CAN_MOVE_THROUGH_FOES_SPACES_HOOKS.addSkill(skillId, () => TRUE_NODE);
    ...
    UNIT_CAN_MOVE_TO_A_SPACE_HOOKS.addSkill(skillId, () =>
        FOR_EACH_TARGETS_FOE_WITHIN_N_SPACES_OF_UNIT_ANY_OF_THE_NEAREST_SPACES_THAT_ARE_M_SPACES_AWAY_FROM_THAT_FOE_NODE(5, 1),
    );
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
    ...
    NON_STATS_SKILL_USING_STATS_HOOKS.addSkill(skillId, NODE_FUNC(
        // deals damage during combat = 20% of the greater of unit’s Spd or Def (excluding area-of-effect Specials),
        DEALS_DAMAGE_X_NODE(PERCENTAGE_NODE(20, MAX_NODE(UNITS_SPD_NODE, UNITS_DEF_NODE))),
    ));
    WHEN_APPLIES_POTENT_EFFECTS_HOOKS.addSkill(skillId, NODE_FUNC(
        // and also, if foe is cavalry or flying,
        // or if decreasing the Spd difference necessary to make a follow-up attack by 25 would allow unit to trigger a follow-up attack
        // (excluding guaranteed or prevented follow-ups),
        ...
        IF_ELSE_NODE(
            OR_NODE(
                ...
                EQ_NODE(FOE_MOVE_NODE, MoveType.Flying),
            ),
            APPLY_POTENT_EFFECT_NODE,
...
// Encouragement
{
    let skillId = PassiveC.Encouragement;
    // At start of turn,
    AT_START_OF_TURN_HOOKS.addSkill(skillId, NODE_FUNC(
        // if unit is within 2 spaces of an ally,
        IF_NODE(IS_TARGET_WITHIN_2_SPACES_OF_TARGETS_ALLY_NODE,
...
// Entwining Horn
{
    let skillId = Weapon.EntwiningHorn;
    // Mt: 14 Rng: 1
    // Accelerates Special trigger (cooldown count-1).
    // At start of player phase or enemy phase,
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        // grants [Imbue], [Resonance: Shields],
        // and “neutralizes foe’s bonuses during combat” to unit,
        // support partner, and allies within 2 spaces of unit for 1 turn.
        FOR_EACH_UNIT_NODE(
            UNITE_UNITS_NODE(TARGET_NODE, TARGETS_PARTNERS_ON_MAP_NODE, TARGETS_ALLIES_WITHIN_2_SPACES_NODE()),
            GRANTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(
                StatusEffectType.Imbue,
    ...
    setCondHooks(skillId,
        ...
        [
            ...
            NODE_FUNC(
                ...
                DEALS_DAMAGE_X_NODE(PERCENTAGE_NODE(20, UNITS_DEF_NODE)),
                // reduces damage from foe’s attacks by 20% of unit’s Def and
                REDUCES_DAMAGE_BY_N_NODE(PERCENTAGE_NODE(20, UNITS_DEF_NODE)),
                // reduces damage from foe’s Specials by an additional 20% of unit’s Def
                // (in either case, including area-of-effect Specials; excluding Røkkr area-of-effect Specials),
                REDUCES_DAMAGE_WHEN_FOES_SPECIAL_EXCLUDING_AOE_SPECIAL_NODE(PERCENTAGE_NODE(20, UNITS_DEF_NODE)),
                // and unit makes a guaranteed follow-up attack during combat,
                UNIT_MAKES_GUARANTEED_FOLLOW_UP_ATTACK_NODE,
...
// Flame Wall
{
    ...
    AT_APPLYING_ONCE_PER_COMBAT_DAMAGE_REDUCTION_HOOKS.addSkill(skillId, NODE_FUNC(
        IF_NODE(
            ...
            IF_NODE(GTE_NODE(UNITS_EVAL_DEF_DURING_COMBAT_NODE, SUB_NODE(FOES_EVAL_DEF_DURING_COMBAT_NODE, 10)),
...
// Heir of Openness
{
    let skillId = PassiveC.HeirOfOpenness;
    // If unit can transform, transformation effects gain
    // “if unit is within 2 spaces of any allies from a different title than unit”
    // as a trigger condition (in addition to existing conditions).
    CAN_TRANSFORM_AT_START_OF_TURN_HOOKS.addSkill(skillId, () =>
        EXISTS_UNITS(
    ...
    setForAlliesHooks(skillId,
        ...
        GRANTS_ATK_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(5),
        SKILL_EFFECT_NODE(
            // reduces damage from foe’s attacks by 7 during combat (excluding area-of-effect Specials),
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        // If unit is within 3 spaces of an ally,
        IF_NODE(IS_TARGET_WITHIN_3_SPACES_OF_TARGETS_ALLY_NODE,
            // grants Atk/Def/Res+5 to unit, deals +7 damage (excluding area-of-effect Specials),
            GRANTS_ATK_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(5),
            DEALS_DAMAGE_X_NODE(7),
            // and reduces damage from foe’s attacks by 7 during combat
            // (excluding area-of-effect Specials; excluding Røkkr area-of-effect Specials),
            REDUCES_DAMAGE_BY_N_NODE(7),
...
// Clouded Blade
{
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_NODE(
            ...
            GRANTS_ALL_STATS_PLUS_5_TO_TARGET_DURING_COMBAT_NODE,
            X_NUM_NODE(
                // reduces damage from foe's attacks by X × 4
                // (excluding area-of-effect Specials), and
                REDUCES_DAMAGE_BY_N_NODE(MULT_NODE(READ_NUM_NODE, 4)),
                // reduces damage from foe's Specials by an additional X × 4 during combat
                // (excluding area-of-effect Specials;
                REDUCES_DAMAGE_WHEN_FOES_SPECIAL_EXCLUDING_AOE_SPECIAL_NODE(MULT_NODE(READ_NUM_NODE, 4)),
                // X = number of spaces from start position to end position of whoever initiated combat; max 3), and also,
                ENSURE_MAX_NODE(NUMBER_OF_SPACES_FROM_START_POSITION_TO_END_POSITION_OF_WHOEVER_INITIATED_COMBAT, 3),
            ),
            // when unit deals damage to foe during combat,
            // restores 7 HP to unit.
...
{
    let skillId = getSpecialRefinementSkillId(Weapon.CloudedBlade);
    // For foes within 3 rows and 3 columns centered on unit,
    setForFoesSkillsDuringCombatHooks(skillId,
        IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE,
        // inflicts Atk/Spd/Def/Res-5 on foe,
        INFLICTS_ALL_STATS_MINUS_5_ON_FOE_DURING_COMBAT_NODE,
        SKILL_EFFECT_NODE(
            ...
            INFLICTS_SPECIAL_COOLDOWN_CHARGE_MINUS_1_ON_FOE_NODE,
            // foe suffers guaranteed follow-up attacks during combat.
            FOE_SUFFERS_GUARANTEED_FOLLOW_UP_ATTACKS_DURING_COMBAT,
        ),
    );
    NON_STATS_SKILL_USING_STATS_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
...
}
{
    ...
    // grants Atk/Spd/Def/Res+5 to unit,
    // unit makes a guaranteed follow-up attack,
    // deals damage = 20% of unit's Def, and
    // reduces damage from foe's attacks by 20% of unit's Def during combat
    // (excluding area-of-effect Specials).
    //
    // At start of turn,
    // if unit is adjacent to only beast or dragon allies
...
}
{
    ...
    setForAlliesHooks(skillId,
        ...
        GRANTS_ATK_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(5),
        SKILL_EFFECT_NODE(
            // neutralizes penalties on ally, and
            NEUTRALIZES_PENALTIES_ON_UNIT_NODE,
...
}
{
    ...
    // inflicts the following effects based on the number of foes within 2 spaces of target (excluding target) during combat:
    // if = 1, inflicts Spd/Res-4 on foe;
    // if ≥ 2, inflicts Spd/Res-8 on foe and foe cannot counterattack.
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // 自分から攻撃した時、または、周囲1マス以内に味方がいない時、戦闘中、攻撃、速さ+6、自分の追撃不可を無効
        IF_NODE(OR_NODE(DOES_UNIT_INITIATE_COMBAT_NODE, IS_NOT_TARGET_ADJACENT_TO_AN_ALLY),
            GRANTS_ATK_SPD_TO_TARGET_DURING_COMBAT_NODE(6),
...
}
{
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE(
            // grants bonus to unit's Atk/Spd =
            GRANTS_ATK_SPD_TO_TARGET_DURING_COMBAT_NODE(
                // 10% of unit's Spd at start of combat + 6, and
...
}
{
    ...
    // grants Atk/Spd/Def/Res+5 to unit,
    // grants additional bonus to unit's Atk/Spd/Def/Res =
    // turn number x 2 (max +10),
    // deals damage = 20% of unit's Spd
    // (including when dealing damage with a Special triggered before combat), and
    // neutralizes effects that guarantee foe's follow-up attacks and
    // effects that prevent unit's follow-up attacks during combat.
    enablesCantoN(skillId, 1);
    setCondHooks(skillId,
        ...
        [
            ...
            NODE_FUNC(
                ...
                // grants additional bonus to unit's Atk/Spd/Def/Res =
                // turn number x 2 (max +10),
                GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(MULT_MAX_NODE(CURRENT_TURN_NODE, 2, 10)),
                NULL_UNIT_FOLLOW_UP_NODE,
            ),
        ],
        [
...
}
{
    ...
    setForFoesSkillsDuringCombatHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            NEUTRALIZES_FOES_BONUSES_TO_STATS_DURING_COMBAT_NODE,
            // foe suffers +10 damage from attacks during combat
            // (excluding area-of-effect Specials).
    ...
    // if unit entered combat on the current turn,
    // grants another action to unit, and re-enables Canto
    // (once per turn; does not trigger when affected by effects of traps in Aether Raids during Canto).
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        IF_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE(
            // grants bonus to unit's Atk/Spd/Def/Res =
            GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
                // number of foes within 3 rows or 3 columns centered on unit + 2 (max 6), and
                ADD_MAX_NODE(NUM_OF_FOES_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_UNIT_NODE, 2, 6),
            ),
...
}
{
    ...
    //
    // At start of combat,
    // if unit's HP ≥ 25%, and also,
    // if unit's max Special cooldown count value ≥ 3 and
    // unit's attack can trigger unit's Special,
    // when unit's Special triggers
    // (excluding area-of-effect Specials),
    // neutralizes "reduces damage by X%" effects from non-Special skills.
    //
    // At start of combat,
    // if unit's HP ≥ 25% and
    // unit triggers the Glowing Ember, Bonfire, or Ignis Special during combat,
    // calculates that attack's damage using the lower of foe's Def or Res.
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // 戦闘開始時、自身のHPが25%以上なら、
        IF_NODE(IS_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE,
            // 戦闘中、攻撃、速さ、守備、魔防+5、
...
}
{
    ...
    AT_START_OF_TURN_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        ...
        // if unit is within 2 spaces of an ally,
        IF_NODE(IS_TARGET_WITHIN_2_SPACES_OF_TARGETS_ALLY_NODE,
            // inflicts Spd/Res-7, [Sabotage], and [Frozen]
            // on closest foes and foes within 2 spaces of those foes
            // through their next actions.
            INFLICTS_STATS_PENALTIES_AND_STATUS_EFFECT_ON_MAP_ON_TARGETS_CLOSEST_FOE_AND_FOES_WITHIN_2_SPACES_NODE(
                SPD_RES_NODE(7),
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        // grants bonus to unit's Atk/Spd/Def/Res =
        GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
            // number of allies within 3 rows or 3 columns centered on unit × 2 + 5 (max 11), and
            MULT_ADD_MAX_NODE(NUM_OF_ALLIES_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_UNIT_NODE, 2, 5, 11),
        ),
...
}
{
    ...
    // neutralizes effects that guarantee foe's follow-up attacks and
    // effects that prevent unit's follow-up attacks,
    // reduces damage from foe's attacks by 30%
    // (excluding area-of-effect Specials), and
    // reduces damage from foe's attacks by 20% of unit's Spd during combat
    // (including area-of-effect Specials; excluding Rokkr area-of-effect Specials).
    AFTER_UNIT_ACTS_IF_CANTO_TRIGGERS_AFTER_CANTO_HOOKS.addSkill(skillId, NODE_FUNC(
        FOR_EACH_SPACES_NODE(SPACES_WITHIN_N_SPACES_OF_TARGET_NODE(2),
            APPLY_DIVINE_VEIN_NODE(DivineVeinType.Flame, TARGET_GROUP_NODE, 1),
        ),
...
}
{
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            // grants bonus to unit's Atk/Spd/Def/Res =
            GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
                // number of allies within 3 rows or 3 columns centered on unit × 2 + 5 (max 11;
                // if unit triggers Savior, value is treated as 11), and
                COND_OP(
            ...
            // unit deals +7 damage during combat
            // (excluding area-of-effect Specials), and also,
            DEALS_DAMAGE_X_NODE(7),
        ),
        SKILL_EFFECT_NODE(
...
}
{
    ...
    //
    // At start of turn,
    // grants Atk/Spd/Def/Res+6 and [Assign Decoy]
    // to any support partner within 2 spaces of unit, or
    // if unit is not on a team with unit's support partner,
    // to ally with the highest Def within 2 spaces of unit for 1 turn.
    //
    // If unit is within 3 spaces of an ally,
    // grants bonus to unit's Atk/Spd/Def/Res during combat =
    // 5 + highest bonus on each stat between allies within 3 spaces of unit
    // (calculates each stat bonus independently), and
    // reduces damage from foe's attacks by 20% of unit's Res during combat
    // (including area-of-effect Specials, excluding Rokkr area-of-effect Specials), and also,
    // if unit's Res > foe's Res,
    // reduces damage from attacks during combat and from area-of-effect Specials
    // by percentage = difference between stats × 4 (max 40%;
    // excluding Rokkr area-of-effect Specials).
...
}
{
    ...
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            // neutralizes unit's penalties to Atk/Res, and
...
// [Fringe Bonus]
{
    ...
    STATS_SKILL_USING_STATS_HOOKS.addSkill(skillId, NODE_FUNC(
        // Grants bonus to unit's Atk/Spd/Def/Res
        FOR_EACH_STAT_INDEX_NODE(
...
// Atk/Spd Aria
{
    let setSkill = (skillId, statsNode, specialStatsNode) => {
        setCondHooks(skillId,
            // If unit initiates combat or is within 3 spaces of an ally,
            OR_NODE(DOES_UNIT_INITIATE_COMBAT_NODE, IS_TARGET_WITHIN_3_SPACES_OF_TARGETS_ALLY_NODE),
            ...
            [
                AT_START_OF_COMBAT_HOOKS,
                NODE_FUNC(
                    GRANTS_STATS_PLUS_TO_TARGET_DURING_COMBAT_NODE(specialStatsNode),
...
// An Open Book
{
    let skillId = PassiveB.AnOpenBook;
    // Enables [Canto (Rem.; Min 1)] .
    enablesCantoRemPlusMin(skillId, 0, 1);
    // At start of player phase or enemy phase,
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, NODE_FUNC(
        // inflicts [Exposure], [Discord], and [Stall]
        ...
        FOR_EACH_UNIT_NODE(
            FILTER_UNITS_NODE(
                ...
                LT_NODE(TARGETS_EVAL_RES_NODE, SKILL_OWNERS_EVAL_RES_ON_MAP),
            ),
            INFLICTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE(
                StatusEffectType.Exposure, StatusEffectType.Discord, StatusEffectType.Stall
            ),
        ),
    ));
    // At start of combat,
    setAtStartOfCombatAndAfterStatsDeterminedHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            TARGET_DEALS_DAMAGE_EXCLUDING_AOE_SPECIALS_NODE(PERCENTAGE_NODE(20, UNITS_RES_NODE)),
            // a reduces damage from foe's attacks by 20% of unit's Res (excluding area-of-effect Specials),
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_EXCLUDING_AOE_SPECIALS_NODE(
                PERCENTAGE_NODE(20, UNITS_RES_NODE)
            ),
            // and grants Special cooldown count-1 to unit before unit's first attack during combat.
...
{
    let skillId = PassiveC.ARHoneAssault;
    // At start of turn,
    AT_START_OF_TURN_HOOKS.addSkill(skillId, NODE_FUNC(
        // if unit is within 2 spaces of an ally,
        IF_NODE(IS_TARGET_WITHIN_2_SPACES_OF_TARGETS_ALLY_NODE,
            // grants Atk/Res+6 and
            // "reduces the percentage of foe's non-Special
            // 'reduce damage by X%' skills by 50% during combat
            // (excluding area-of-effect Specials)"
            // to unit and allies within 2 spaces of unit for 1 turn.
    ...
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, NODE_FUNC(
        // Grants bonus to unit's Atk/Res during combat =
        GRANTS_ATK_RES_TO_TARGET_DURING_COMBAT_NODE(
            // 2 + number of allies on the map with the
            // "reduces the percentage of foe's non-Special
            // 'reduce damage by X%' skills by 50% during combat
            // (excluding area-of-effect Specials)"
            // status effect active, excluding unit (max 5).
            ADD_MAX_NODE(
                2,
                NUM_OF_TARGETS_ALLIES_NODE(
...
// 🅱️ True Lone Wolf
{
    ...
    AFTER_ACTION_WITHOUT_COMBAT_FOR_ANOTHER_ACTION_HOOKS.addSkill(skillId, () => new SkillEffectNode(
        IF_NODE(AND_NODE(
                IF_TARGET_HAS_NOT_USED_ASSIST_DURING_CURRENT_TURN_NODE,
                IF_TARGET_HAS_NOT_BEEN_TARGET_OF_ASSIST_DURING_CURRENT_TURN_NODE,
                NOT_NODE(IS_TARGET_AFFECTED_BY_FORESIGHT_SNARE_NODE),
                NOT_NODE(IS_TARGET_AFFECTED_BY_TRAP_NODE)
            ),
        ...
        GRANTS_ATK_SPD_DEF_RES_TO_TARGET_DURING_COMBAT_NODE(
            ...
            IF_VALUE_NODE(
                IS_THERE_TARGETS_ALLY_ON_MAP_NODE(
                    AND_NODE(
                        LTE_NODE(DISTANCE_BETWEEN_UNITS_NODE(TARGET_NODE, SKILL_OWNER_NODE), 3),
                        ARE_TARGET_AND_SKILL_OWNER_PARTNERS_NODE
                    ),
                ),
                11,
...
// 🅱️ S/R Lull Finish
{
    let setSkill = (skillId, inflictsNode, flags) => {
        AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
            // Inflicts Spd/Res-4 on foe,
            inflictsNode(4),
            ...
            // neutralizes foe’s bonuses to Spd/Res,
            NEUTRALIZES_FOES_EACH_BONUSES_TO_STATS_DURING_COMBAT_NODE(...flags),
            // and reduces damage from foe’s attacks by 7 during combat
            // (excluding area-of-effect Specials),
            REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_DURING_COMBAT_NODE(7),
            // and also,
...
}
{
    ...
    setForAlliesHooks(skillId,
        AND_NODE(
            ...
            INCLUDES_UNIT_NODE(TARGET_NODE, SKILL_OWNERS_PARTNERS_OTHERWISE_HIGHEST_STAT_ALLIES_NODE(StatusIndex.DEF))),
...
// Noble Bow
{
    ...
    setForFoesSkillsDuringCombatHooks(skillId,
        ...
        SKILL_EFFECT_NODE(
            ...
            // that effect will also neutralize this skill's
            // "cannot recover HP after combat" effect on their foes.)
            FOR_FOE_NODE(TARGET_CANNOT_RECOVER_HP_DURING_COMBAT_NODE),
            FOR_FOE_NODE(TARGET_CANNOT_RECOVER_HP_AFTER_COMBAT_NEUTRALIZED_WHEN_FEUD_NODE),
        ),
    );
    AT_START_OF_COMBAT_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // At start of combat, if unit's HP ≥ 25%,
    ...
    setAtStartOfPlayerPhaseOrEnemyPhase(skillId, () => SKILL_EFFECT_NODE(
        FOR_EACH_UNIT_NODE(
            UNITE_UNITS_NODE(
                SKILL_OWNER_NODE,
                FILTER_UNITS_NODE(
                    SKILL_OWNERS_PARTNERS_OTHERWISE_HIGHEST_STAT_ALLIES_NODE(StatusIndex.DEF),
                    IS_TARGET_WITHIN_3_SPACES_OF_SKILL_OWNER_NODE),
            ),
...
// 🅲 For the True King
{
    ...
    CAN_TRIGGER_SAVIOR_HOOKS.addSkill(skillId, () =>
        ...
        AND_NODE(
            ...
            INCLUDES_UNIT_NODE(TARGET_NODE, SKILL_OWNERS_PARTNERS_OTHERWISE_HIGHEST_STAT_ALLIES_NODE(StatusIndex.ATK)),
        ),
    );
    // (If support partner is on player team,
...
// [Fire Emblem]
{
    ...
    STATS_SKILL_USING_STATS_HOOKS.addSkill(skillId, () => SKILL_EFFECT_NODE(
        // Grants bonus to unit's Atk/Spd/Def/Res
        FOR_EACH_STAT_INDEX_NODE(
            // = highest bonus on each stat between unit and allies within 2 spaces of unit
            // (calculates each stat bonus independently)
...
// Dragon Fang Fire
{
    ...
    NON_STATS_SKILL_USING_STATS_HOOKS.addSkill(skillId, () => reduceNode);
...
// 命脈
{
    ...
    setSkill(PassiveA.TorrentialBoost, GRANTS_ATK_SPD_RES_TO_TARGET_DURING_COMBAT_NODE(9));
}
