 ...
 * ワープでの再移動
 * @type {SkillEffectHooks<CollectionNode<*, Tile>, BattleMapEnv>} */
const UNIT_CAN_MOVE_TO_A_SPACE_WITHOUT_OBSTRUCTION_HOOKS = new SkillEffectHooks();
 ...
 * 周囲に対する紋章効果(ステータス決定後)
 * @type {SkillEffectHooks<SkillEffectNode, ForAlliesEnv>} */
const FOR_ALLIES_STATS_SKILLS_USING_STATS_HOOKS = new SkillEffectHooks();
 ...
 * 敵ターン開始時の化身のタイミング
 * @type {SkillEffectHooks<SkillEffectNode, AtStartOfTurnEnv>} */
const CAN_TRANSFORM_AT_START_OF_ENEMY_TURN_HOOKS = new SkillEffectHooks();
...
export { AT_START_OF_COMBAT_HOOKS, CAN_TRIGGER_CANTO_HOOKS, CALCULATES_DISTANCE_OF_CANTO_HOOKS, CALCULATES_DISTANCE_OF_CANTO_WHEN_CANTO_CONTROL_IS_APPLIED_HOOKS, WHEN_CANTO_UNIT_CAN_MOVE_TO_A_SPACE_HOOKS, WHEN_CANTO_ALLY_CAN_MOVE_TO_A_SPACE_HOOKS };
export { UNIT_CAN_MOVE_TO_A_SPACE_WITHOUT_OBSTRUCTION_HOOKS, WHEN_CANTO_TRIGGERS_HOOKS, AT_START_OF_TURN_HOOKS, AT_START_OF_ENEMY_PHASE_HOOKS, AT_START_OF_TURN_AFTER_HEALING_AND_DAMAGE_HOOKS, AT_START_OF_ENEMY_PHASE_AFTER_HEALING_AND_DAMAGE_SKILLS_HOOKS };
export { AFTER_START_OF_TURN_EFFECTS_TRIGGER_ON_PLAYER_PHASE_HOOKS, AFTER_START_OF_TURN_EFFECTS_TRIGGER_ON_ENEMY_PHASE_HOOKS, CANCEL_FOES_ATTACK_HOOKS, AFTER_CANCEL_FOES_ATTACK_HOOKS, BEFORE_AOE_SPECIAL_ACTIVATION_CHECK_HOOKS, BEFORE_COMBAT_HOOKS, FOR_FOES_CAN_INFLICT_CANTO_CONTROL_HOOKS };
export { CAN_INFLICT_CANTO_CONTROL_HOOKS, CAN_NEUTRALIZE_STATUS_EFFECTS_HOOKS, CAN_NEUTRALIZE_END_ACTION_BY_SKILL_EFFECTS_HOOKS, CAN_NEUTRALIZE_END_ACTION_BY_STATUS_EFFECTS_HOOKS, FOR_ALLIES_GRANTS_STATS_PLUS_TO_ALLIES_DURING_COMBAT_HOOKS, FOR_ALLIES_AT_START_OF_COMBAT_HOOKS };
export { FOR_ALLIES_STATS_SKILLS_USING_STATS_HOOKS, FOR_ALLIES_NON_STATS_SKILL_USING_STATS_HOOKS, FOR_ALLIES_GRANTS_EFFECTS_TO_ALLIES_AFTER_OTHER_SKILLS_DURING_COMBAT_HOOKS, FOR_ALLIES_GRANTS_EFFECTS_TO_ALLIES_AFTER_COMBAT_HOOKS, FOR_FOES_INFLICTS_STATS_MINUS_HOOKS };
export { FOR_FOE_STATS_SKILLS_USING_STATS_HOOKS, FOR_FOE_NON_STATS_SKILL_USING_STATS_HOOKS, FOR_FOES_AT_START_OF_COMBAT_HOOKS, FOR_FOES_INFLICTS_EFFECTS_AFTER_OTHER_SKILLS_HOOKS, WHEN_TRIGGERS_DUO_OR_HARMONIZED_EFFECT_HOOKS_MAP, WHEN_TRIGGERS_DUO_OR_HARMONIZED_EFFECT_HOOKS };
export { CAN_TRIGGER_DUO_OR_HARMONIZED_EFFECT_HOOKS_MAP, WHEN_APPLIES_POTENT_EFFECTS_HOOKS, FOR_ALLIES_WHEN_APPLIES_POTENT_EFFECTS_HOOKS, CAN_TRIGGER_SAVIOR_HOOKS, AFTER_COMBAT_HOOKS, AFTER_COMBAT_AFTER_HEAL_OR_DAMAGE_HOOKS, AFTER_COMBAT_EVEN_IF_DEFEATED_HOOKS, AFTER_COMBAT_IF_UNIT_ATTACKED_HOOKS };
export { FOR_ALLIES_AFTER_COMBAT_HOOKS, AFTER_COMBAT_FOR_ALLIES_EVEN_IF_DEFEATED_HOOKS, STATS_SKILL_USING_STATS_HOOKS, NON_STATS_SKILL_USING_STATS_HOOKS, WHEN_APPLIES_SPECIAL_EFFECTS_AT_START_OF_COMBAT_HOOKS, AT_START_OF_ATTACK_HOOKS, AFTER_ATTACK_HOOKS };
export { AFTER_UNIT_ACTS_IF_CANTO_TRIGGERS_AFTER_CANTO_HOOKS, AFTER_CANTO_HOOKS, AFTER_FOLLOW_UP_CONFIGURED_HOOKS, AFTER_CONDITION_CONFIGURED_HOOKS, AT_COMPARING_STATS_HOOKS, AFTER_COMBAT_FOR_ANOTHER_ACTION_HOOKS, AFTER_COMBAT_FOR_ANOTHER_ACTION_THAT_HAS_PRIORITY_OVER_OTHER_SKILLS_HOOKS };
export { FOR_ALLIES_AFTER_COMBAT_FOR_ANOTHER_ACTION_AFTER_OWN_ANOTHER_ACTION_HOOKS, AFTER_ALLIES_COMBAT_FOR_ANOTHER_ACTION_HOOKS, AFTER_COMBAT_FOR_FOES_ANOTHER_ACTION_HOOKS, AFTER_ACTION_WITHOUT_COMBAT_FOR_ANOTHER_ACTION_HOOKS, AFTER_BEING_GRANTED_ANOTHER_ACTION_AFTER_COMBAT_HOOKS };
export { AFTER_BEING_GRANTED_ANOTHER_ACTION_ON_ASSIST_HOOKS, BEFORE_AOE_SPECIAL_HOOKS, AT_APPLYING_ONCE_PER_COMBAT_DAMAGE_REDUCTION_HOOKS, AFTER_RALLY_SKILL_IS_USED_BY_UNIT_HOOKS, AFTER_RALLY_SKILL_IS_USED_BY_ALLY_HOOKS, AFTER_MOVEMENT_SKILL_IS_USED_BY_UNIT_HOOKS };
export { AFTER_MOVEMENT_SKILL_IS_USED_BY_ALLY_HOOKS, AFTER_REFRESH_SKILL_IS_USED_BY_UNIT_HOOKS, AFTER_REFRESH_SKILL_IS_USED_BY_ALLY_HOOKS, AFTER_REFRESH_ENDED_BY_UNIT_HOOKS, AFTER_RALLY_ENDED_BY_UNIT_HOOKS, AFTER_RALLY_ENDED_BY_ALLY_HOOKS, AFTER_RALLY_ENDED_BY_OTHER_UNIT_HOOKS };
export { AFTER_MOVEMENT_ASSIST_ENDED_BY_UNIT_HOOKS, AFTER_MOVEMENT_ASSIST_ENDED_BY_ALLY_HOOKS, AFTER_MOVEMENT_ASSIST_ENDED_BY_OTHER_UNIT_HOOKS, CAN_RALLY_FORCIBLY_HOOKS, CAN_RALLIED_FORCIBLY_HOOKS, HAS_DIVINE_VEIN_SKILLS_WHEN_ACTION_DONE_HOOKS, CAN_TRANSFORM_AT_START_OF_TURN_HOOKS };
export { CAN_TRANSFORM_AT_START_OF_ENEMY_TURN_HOOKS, UNIT_CAN_MOVE_TO_A_SPACE_HOOKS, ALLY_CAN_MOVE_TO_A_SPACE_HOOKS, UNIT_CAN_MOVE_THROUGH_FOES_SPACES_HOOKS, UNIT_CANNOT_WARP_INTO_SPACES_HOOKS, AFTER_EFFECTS_THAT_DEAL_DAMAGE_AS_COMBAT_BEGINS_HOOKS };
export { FOR_ALLIES_AFTER_EFFECTS_THAT_DEAL_DAMAGE_AS_COMBAT_BEGINS_HOOKS, CANNOT_FOE_MOVE_THROUGH_SPACES_ADJACENT_TO_UNIT_HOOKS, CANNOT_FOE_MOVE_THROUGH_SPACES_WITHIN_2_SPACES_OF_UNIT_HOOKS, CANNOT_UNIT_MOVE_THROUGH_SPACES_WITHIN_2_SPACES_OF_FOE_HOOKS };
export { CANNOT_UNIT_MOVE_THROUGH_SPACES_WITHIN_3_SPACES_OF_FOE_HOOKS, AOE_SPECIAL_SPACES_HOOKS, CALC_HEAL_AMOUNT_HOOKS, CANNOT_MOVE_STYLE_ATTACK_RANGE_HOOKS, CAN_ACTIVATE_STYLE_HOOKS, STYLE_ACTIVATED_HOOKS, SUFFERS_COUNTERATTACK_DURING_STYLE_HOOKS };
export { CAN_ATTACK_FOES_N_SPACES_AWAY_DURING_STYLE_HOOKS, CAN_ATTACK_FOES_N_SPACES_AWAY_HOOKS, IS_DEBUFFER_TIER_1_HOOKS, IS_DEBUFFER_TIER_2_HOOKS, IS_AFFLICTOR_HOOKS, HAS_PATHFINDER_HOOKS, GET_COLOR_WHEN_DETERMINING_WEAPON_TRIANGLE_HOOKS, CALC_TRIANGLE_ADVANTAGE_HOOKS };
export { IS_ASSIGN_DECOY_FOR_SAME_RANGE_ACTIVE_HOOKS, DOES_UNIT_MOVE_1_SPACE_AWAY_AFTER_COMBAT_HOOKS, DURING_COMBAT_INCLUDING_AOE_HOOKS, DURING_COMBAT_USING_STATS_INCLUDING_AOE_HOOKS };
