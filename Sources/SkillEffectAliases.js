import {
    ADD_NODE, AND_NODE, APPLY_X_NODE, BoolNode, COND_OP, ConstantNumberNode,
    ENSURE_MAX_NODE, ENSURE_MIN_MAX_NODE, ENSURE_MIN_NODE, EQ_NODE, EnsureMaxNode,
    EqNode, FALSE_NODE, FLATTEN_COLLECTION_NODE, GTE_NODE, GT_NODE, GtNode,
    IF_ELSE_NODE, IF_EXPRESSION_NODE, IF_NODE, INT_PERCENTAGE_NUMBER_NODE, IfNode,
    LTE_NODE, MAX_NODE, MIN_NODE, MULT_CEIL_NODE, MULT_NODE, MULT_TRUNC_NODE,
    MultTruncNode, NODE_FUNC, NOT_NODE, NumThatIsNode, NumberNode, OR_NODE,
    PositiveNumberNode, READ_NUM_NODE, SET_SIZE_NODE, SKILL_EFFECT_NODE, SUB_NODE,
    SUM_NODE, SkillEffectHooks, SkillEffectNode, SubNode, TRUE_NODE,
    TernaryConditionalNumberNode, UNION_SET_NODE, UNIQUE_COLLECTION_NODE, X_NUM_NODE,
...
import {
    ...
    ASSIST_TARGETING_NODE, ASSIST_TARGET_NODE,
    ApplyingNumberNode, CANTO_DIST_PLUS_NODE,
    CAN_FOES_ATTACK_TRIGGER_FOES_SPECIAL_NODE,
    CAN_PLACE_TARGET_ON_SPACE_NODE,
    COUNT_IF_UNITS_NODE, COUNT_UNITS_NODE, CURRENT_TURN_NODE,
    CalcPotentialDamageNode, CantoDistNode, CantoRemNode, CountIfUnitsNode,
    FILTER_SPACES_NODE, FILTER_UNITS_NODE,
    FOES_EVAL_DEF_AT_START_OF_COMBAT_NODE, FOES_EVAL_DEF_DURING_COMBAT_NODE,
    FOES_EVAL_RES_AT_START_OF_COMBAT_NODE, FOES_EVAL_RES_DURING_COMBAT_NODE,
    FOES_EVAL_SPD_AT_START_OF_COMBAT_NODE, FOES_EVAL_SPD_DURING_COMBAT_NODE,
    FOES_EVAL_STAT_AT_START_OF_COMBAT_NODE,
    FOES_STAT_AT_START_OF_COMBAT_NODE, FOES_STAT_DURING_COMBAT_NODE,
    FOE_AND_FOES_ALLIES_ON_MAP_NODE, FOE_NODE,
    ...
    FOR_EACH_UNIT_NODE, FOR_FOE_NODE, FOR_TARGETS_FOE_DURING_COMBAT_NODE,
    FilterUnitsNode, FoesBonusNode, FoesMaxHpNode, FoesRangeNode, ForEachUnitNode,
    GET_STAT_AT_NODE,
    ...
    HAS_TARGET_ATTACKED_NODE, HAS_TARGET_BEEN_ATTACKED_NODE,
    HAS_TARGET_ENTERED_COMBAT_DURING_CURRENT_TURN_NODE,
    HAS_TARGET_PERFORMED_ACTION_NODE,
    HasAssistTargetingStatusEffectNode, HasTargetStatusEffectNode,
    ...
    IS_IN_COMBAT_PHASE_NODE, IS_NOT_SUMMONER_DUELS_MODE_NODE,
    ...
    IS_TARGET_MAGIC_WEAPON_NODE, IS_TARGET_P_WEAPON_NODE,
    ...
    IsBonusActiveOnTargetNode, IsPenaltyActiveOnTargetNode,
    IsTargetBeastOrDragonTypeNode, IsTargetMoveTypeNode,
    IsTargetSkillOwnerNode, IsTargetTransformedNode,
    ...
    MAP_UNION_UNITS_NODE, MAP_UNITS_NODE, MAP_UNITS_TO_NUM_NODE,
    MAX_UNITS_NODE, MapUnitsToNumNode,
    NUM_OF_TARGETS_ALLIES_WITHIN_3_SPACES_NODE,
    NumOfTargetsAlliesWithinNSpacesNode, PERCENTAGE_NODE,
    RE_ENABLES_CANTO_TO_TARGET_ON_MAP_NODE,
    SET_TARGET_REST_STYLE_SKILL_AVAILABLE_TURN_NODE,
    SKILL_OWNERS_FOES_ON_MAP_NODE, SKILL_OWNERS_PLACED_SPACE_NODE,
    SKILL_OWNER_NODE,
    ...
    SkillOwnersEvalStatOnMapNode, SkillOwnersStatOnMapNode, StatsNode,
    TARGETS_ALLIES_ON_MAP_NODE, TARGETS_ALLIES_WITHIN_N_SPACES_NODE,
    TARGETS_AND_THOSE_ALLIES_WITHIN_N_SPACES_NODE,
    TARGETS_BONUSES_NODE, TARGETS_FOES_NODE, TARGETS_FOE_NODE,
    TARGETS_MAX_HP_EXCLUDING_HP_INCREASES_FROM_LEGENDARY_EFFECTS_MYTHIC_EFFECTS_BONUS_HEROES_ETC_NODE,
    TARGETS_MAX_HP_NODE, TARGETS_MAX_SPECIAL_COUNT_NODE,
    TARGETS_ONCE_PER_TURN_SKILL_EFFECT_NODE,
    TARGETS_PENALTIES_NODE, TARGETS_PLACED_SPACE_NODE,
    TARGETS_RANGE_NODE, TARGETS_SPECIAL_COOLDOWN_COUNT_ON_MAP_NODE,
    TARGETS_STATS_ON_MAP_NODE, TARGETS_TITLE_SET_NODE,
    TARGETS_TOTAL_BONUSES_NODE, TARGETS_TOTAL_PENALTIES_NODE,
    TARGET_NODE,
    TargetsAlliesWithinNSpacesNode, TargetsAndThoseAlliesWithinNSpacesNode,
    TargetsBonusNode, TargetsClosestFoesNode,
    TargetsClosestFoesWithinNSpacesNode, TargetsEvalStatOnMapNode,
    TargetsMaxHpNode, TargetsMaxSpecialCountNode, TargetsMoveTypeNode,
    TargetsPlaceableSpacesWithinNSpacesFromSpaceNode,
    TargetsRangeNode, TargetsSpecialCountAtStartOfTurnNode,
    TargetsStatOnMapNode, TargetsTotalPenaltiesNode,
    UNITE_SPACES_NODE, UNITE_UNITS_NODE,
    UNITS_CURRENT_SPECIAL_COOLDOWN_COUNT_DURING_COMBAT,
    UNITS_EVAL_DEF_AT_START_OF_COMBAT_NODE, UNITS_EVAL_DEF_DURING_COMBAT_NODE,
    UNITS_EVAL_RES_AT_START_OF_COMBAT_NODE, UNITS_EVAL_RES_DURING_COMBAT_NODE,
    UNITS_EVAL_SPD_AT_START_OF_COMBAT_NODE, UNITS_EVAL_SPD_DURING_COMBAT_NODE,
    UNITS_EVAL_STAT_AT_START_OF_COMBAT_NODE,
    UNITS_STAT_AT_START_OF_COMBAT_NODE, UNITS_STAT_DURING_COMBAT_NODE,
    UniteSpacesIfNode, UnitsNode,
    UnitsOfBothAssistTargetingAndAssistTargetNode, UnitsOnMapNode,
    getSkillLogLevel,
} from './SkillEffect.js';
...
import {
    ...
    DOES_TARGET_INITIATE_COMBAT_NODE, DOES_UNIT_INITIATE_COMBAT_NODE,
    DamageDealtToTargetAsCombatBeginsNode,
    EffectiveAgainstNode,
    FOE_CANNOT_TRIGGER_ATTACKER_SPECIAL, FOE_CANNOT_TRIGGER_DEFENDER_SPECIAL,
    ...
    TARGETS_HP_DURING_COMBAT_NODE, TARGETS_HP_ON_MAP_NODE,
    ...
    UNIT_CANNOT_TRIGGER_ATTACKER_SPECIAL, UNIT_CANNOT_TRIGGER_DEFENDER_SPECIAL,
    ...
    UnitDealsDamageBeforeCombatNode, UnitDealsDamageExcludingAoeSpecialsNode,
    WhenTargetDealsDamageDuringCombatRestoresNHpToTargetNode,
} from './SkillEffectBattleContext.js';

import {
    AFTER_CANTO_HOOKS, AFTER_FOLLOW_UP_CONFIGURED_HOOKS,
    ...
    AT_START_OF_ATTACK_HOOKS, AT_START_OF_COMBAT_HOOKS,
    AT_START_OF_ENEMY_PHASE_AFTER_HEALING_AND_DAMAGE_SKILLS_HOOKS,
    AT_START_OF_ENEMY_PHASE_HOOKS, AT_START_OF_TURN_HOOKS,
    BEFORE_AOE_SPECIAL_ACTIVATION_CHECK_HOOKS, BEFORE_AOE_SPECIAL_HOOKS,
    ...
    FOR_FOES_AT_START_OF_COMBAT_HOOKS, FOR_FOES_INFLICTS_STATS_MINUS_HOOKS,
    NON_STATS_SKILL_USING_STATS_HOOKS, STYLE_ACTIVATED_HOOKS,
    UNIT_CAN_MOVE_TO_A_SPACE_HOOKS,
    WHEN_CANTO_UNIT_CAN_MOVE_TO_A_SPACE_HOOKS,
} from './SkillEffectHooks.js';

import {
    ASSIST_RANGE_MAP, BEAST_COMMON_SKILL_MAP,
    CAN_SAVE_FROM_MAGIC_SKILL_SET, CAN_SAVE_FROM_MELEE_SKILL_SET,
    CAN_SAVE_FROM_P_SKILL_SET, CAN_SAVE_FROM_RANGED_SKILL_SET,
    COUNT2_SPECIALS, COUNT3_SPECIALS, COUNT4_SPECIALS, COUNT5_SPECIALS,
    DEFENSE_SPECIAL_SET, GALEFORCE_SKILLS,
    INHERITABLE_COUNT2_SPECIALS, INHERITABLE_COUNT3_SPECIALS,
    INHERITABLE_COUNT4_SPECIALS, INHERITABLE_COUNT5_SPECIALS,
    ...
    RALLY_BUFF_AMOUNT_MAP, RALLY_HEAL_SKILL_SET,
    RANGED_ATTACK_SPECIAL_DAMAGE_RATE_MAP,
    REFRESH_SUPPORT_SKILL_SET, SAVE_SKILL_SET,
    WEAPON_TYPES_ADD_ATK2_AFTER_TRANSFORM_SET,
    calcHealAmountFuncMap, canAddStatusEffectByRallyFuncMap,
    canRallyForciblyByPlayerFuncMap, canRallyForciblyFuncMap,
    getAssistTypeWhenCheckingCanActivatePrecombatAssistFuncMap,
} from './Skill.js';

import { AssistType, EffectiveType, EmblemHero, SKILL_ID_TO_STYLE_TYPE } from './SkillConstants.js';
...
const SKILL_OWNER_AND_SKILL_OWNERS_ALLIES_WITHIN_N_SPACES =
    n => UNITE_UNITS_NODE(SKILL_OWNER_NODE, SKILL_OWNERS_ALLIES_WITHIN_N_SPACES(n));
...
const HIGHEST_PENALTY_ON_EACH_STAT_BETWEEN_TARGET_AND_TARGET_ALLIES_WITHIN_N_SPACES_NODE =
    (index, n) =>
        GET_STAT_AT_NODE(HIGHEST_PENALTIES_ON_EACH_STAT_BETWEEN_TARGET_AND_TARGET_ALLIES_WITHIN_N_SPACES_NODE(n), index);
...
function setAfterStartOfTurnEffectsTriggerOnPlayerOrEnemyPhaseExceptForInSummonerDuelsHooks(skillId, nodeFunc) {
    AFTER_START_OF_TURN_EFFECTS_TRIGGER_ON_PLAYER_PHASE_HOOKS.addSkill(skillId, nodeFunc);
    AFTER_START_OF_TURN_EFFECTS_TRIGGER_ON_ENEMY_PHASE_HOOKS.addSkill(skillId, NODE_FUNC(
        IF_NODE(IS_NOT_SUMMONER_DUELS_MODE_NODE, nodeFunc()),
    ));
}
...
export { IS_THERE_NO_DIVINE_VEIN_ICE_CURRENTLY_APPLIED_BY_TARGET_OR_TARGETS_ALLIES_NODE, UNITS_STAT_NODE, UNITS_ATK_NODE, UNITS_SPD_NODE, UNITS_DEF_NODE, UNITS_RES_NODE, FOES_STAT_NODE, FOES_ATK_NODE, FOES_SPD_NODE, FOES_DEF_NODE, FOES_RES_NODE, UNITS_EVAL_SPD_NODE, FOES_EVAL_SPD_NODE };
export { UNITS_EVAL_DEF_NODE, FOES_EVAL_DEF_NODE, UNITS_EVAL_RES_NODE, FOES_EVAL_RES_NODE, SPD_DIFF_NODE, RES_DIFF_NODE, TARGETS_SPECIAL_COOLDOWN_COUNT_NODE, setForAlliesHooks, IS_THERE_UNITS_IF, IS_IT_TARGETS_FIRST_COMBAT_INITIATED_BY_TARGET_IN_PLAYER_PHASE_OR_ENEMY_PHASE_NODE };
export { IS_IT_FIRST_COMBAT_INITIATED_BY_TARGETS_FOE_IN_PLAYER_PHASE_OR_ENEMY_PHASE_NODE, IS_IT_TARGETS_FIRST_COMBAT_INITIATED_BY_TARGET_OR_FIRST_COMBAT_INITIATED_BY_TARGETS_FOE_IN_PLAYER_PHASE_OR_ENEMY_PHASE_NODE, TARGET_CAN_ACTIVATE_NON_SPECIAL_MIRACLE_ONCE_PER_TURN_NODE };
export { IS_THERE_SKILL_OWNERS_PARTNER_ON_MAP_NODE, FOE_AND_FOES_ALLIES_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_FOE_NODE, SKILL_OWNER_AND_SKILL_OWNERS_ALLIES_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE, SKILL_OWNERS_ALLIES_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE };
export { SKILL_OWNERS_FOES_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE, IS_THERE_SKILL_OWNERS_FOE_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE, NUM_OF_PENALTY_ON_FOE_AND_FOES_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_THAT_FOE_EXCLUDING_STAT_NODE };
export { ASSIST_TARGETING_AND_TARGET_NODE, TOTAL_DAMAGE_DEALT_TO_TARGET_DURING_COMBAT_NODE, TOTAL_DAMAGE_DEALT_TO_FOE_DURING_COMBAT_NODE, PERCENTAGE_NODE, PERCENTAGE_CEIL_NODE, PERCENTAGE_ADD_NODE, PERCENTAGE_SUB_NODE, TARGETS_CLOSEST_FOES_WITHIN_4_SPACES_NODE };
export { TARGETS_CLOSEST_FOES_WITHIN_5_SPACES_NODE, TARGETS_CLOSEST_FOES_WITHIN_5_SPACES_AND_FOES_ALLIES_WITHIN_2_SPACES_OF_THOSE_FOES_NODE, TARGETS_CLOSEST_FOES_NODE, TARGETS_CLOSEST_FOES_AND_FOES_ALLIES_WITHIN_N_SPACES_OF_THOSE_FOES_NODE };
export { CLOSEST_FOES_WITHIN_5_SPACES_OF_BOTH_ASSIST_TARGETING_AND_ASSIST_TARGET_AND_FOES_WITHIN_2_SPACES_OF_THOSE_FOES_NODE, NUM_OF_TARGETS_FOES_ON_MAP_WITH_STATUS_EFFECT_ACTIVE_NODE, TARGETS_FOES_THAT_ARE_WITHIN_N_SPACES_OF_ANOTHER_TARGETS_FOE_NODE };
export { TARGETS_FOES_THAT_ARE_WITHIN_2_SPACES_OF_ANOTHER_TARGETS_FOE_NODE, RESTORE_X_HP_LIKE_BREATH_OF_LIFE_4_NODE, setDivineNectarAnotherActionSkill, BOOST_3_NODE, TARGETS_STAT_ON_MAP, TARGETS_ATK_ON_MAP, TARGETS_SPD_ON_MAP, TARGETS_DEF_ON_MAP, TARGETS_RES_ON_MAP, TARGETS_EVAL_STAT_ON_MAP };
export { TARGETS_EVAL_ATK_ON_MAP, TARGETS_EVAL_SPD_ON_MAP, TARGETS_EVAL_DEF_ON_MAP, TARGETS_EVAL_RES_ON_MAP, SKILL_OWNERS_STAT_ON_MAP, SKILL_OWNERS_ATK_ON_MAP, SKILL_OWNERS_SPD_ON_MAP, SKILL_OWNERS_DEF_ON_MAP, SKILL_OWNERS_RES_ON_MAP, SKILL_OWNERS_EVAL_STAT_ON_MAP, SKILL_OWNERS_EVAL_ATK_ON_MAP };
export { SKILL_OWNERS_EVAL_SPD_ON_MAP, SKILL_OWNERS_EVAL_DEF_ON_MAP, SKILL_OWNERS_EVAL_RES_ON_MAP, UNITS_STAT_GT_FOES_STAT_AT_START_OF_COMBAT_NODE, DIFFERENCE_BETWEEN_STATS_AT_START_OF_COMBAT_NODE, DIFFERENCE_BETWEEN_RES_STATS_AT_START_OF_COMBAT_NODE, UNITS_DEF_GT_FOES_DEF_DURING_COMBAT_NODE };
export { UNITS_RES_GT_FOES_RES_DURING_COMBAT_NODE, DIFFERENCE_BETWEEN_SPD_STATS_NODE, DIFFERENCE_BETWEEN_DEF_STATS_DURING_COMBAT_NODE, DIFFERENCE_BETWEEN_RES_STATS_DURING_COMBAT_NODE, DIFFERENCE_BETWEEN_DEF_STATS_NODE, DIFFERENCE_BETWEEN_RES_STATS_NODE, TARGET_STAT_BONUS_NODE };
export { TARGET_ATK_BONUS_NODE, TARGET_SPD_BONUS_NODE, TARGET_DEF_BONUS_NODE, TARGET_RES_BONUS_NODE, FOES_STAT_BONUS_NODE, FOES_ATK_BONUS_NODE, FOES_SPD_BONUS_NODE, FOES_DEF_BONUS_NODE, FOES_RES_BONUS_NODE, NUM_OF_BONUSES_AND_PENALTIES_ACTIVE_ON_TARGET_EXCLUDING_STAT_NODE };
export { BONUSES_ACTIVE_ON_TARGET_EXCLUDING_STAT_SET_NODE, PENALTIES_ACTIVE_ON_TARGET_EXCLUDING_STAT_SET_NODE, BONUSES_AND_PENALTIES_ACTIVE_ON_TARGET_EXCLUDING_STAT_SET_NODE, NUM_OF_BONUSES_ON_TARGET_AND_PENALTIES_ON_FOE_EXCLUDING_STAT_NODE, TARGET_DEALS_DAMAGE_X_NODE, DEALS_DAMAGE_X_NODE };
export { DEALS_DAMAGE_X_PERCENTAGE_OF_UNITS_STAT_NODE, DEALS_DAMAGE_PERCENTAGE_OF_TARGETS_STAT_NODES, REDUCES_DAMAGE_BY_N_NODES, REDUCES_DAMAGE_BY_N_NODE, REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_N_NODE, REDUCES_DAMAGE_FROM_SPECIALS_BY_N_NODE };
export { REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_N_PERCENT_NODE, IS_TARGETS_SPECIAL_COOLDOWN_COUNT_AT_ITS_MAX_AT_START_OF_TURN_NODE, AT_START_OF_TURN_IF_TARGETS_SPECIAL_COOLDOWN_COUNT_IS_AT_ITS_MAXIMUM_VALUE_GRANTS_SPECIAL_COOLDOWN_COUNT_MINUS_X_NODE };
export { IF_TARGETS_SPECIAL_COOLDOWN_COUNT_IS_AT_ITS_MAXIMUM_VALUE_GRANTS_SPECIAL_COOLDOWN_COUNT_MINUS_X_NODE, IF_TARGETS_SPECIAL_COOLDOWN_COUNT_IS_AT_ITS_MAXIMUM_VALUE_MINUS_1_GRANTS_SPECIAL_COOLDOWN_COUNT_MINUS_X_NODE, FOES_RANGE_IS_1_NODE, FOES_RANGE_IS_2_NODE };
export { IS_TARGET_BEAST_OR_DRAGON_TYPE_NODE, IS_TARGET_INFANTRY_NODE, IS_TARGET_FLYING_NODE, IS_TARGET_CAVALRY_NODE, IS_TARGET_ARMOR_NODE, IS_FOE_INFANTRY_NODE, IS_FOE_FLYING_NODE, IS_FOE_CAVALRY_NODE, IS_FOE_ARMOR_NODE, FOE_CANNOT_TRIGGER_SPECIALS_DURING_COMBAT_NODE };
export { UNIT_CANNOT_TRIGGER_SPECIALS_DURING_COMBAT_NODE, IF_UNIT_INITIATES_COMBAT_OR_IS_WITHIN_2_SPACES_OF_AN_ALLY, IF_UNIT_INITIATES_COMBAT_OR_IS_WITHIN_3_SPACES_OF_AN_ALLY, setCalculatesDamageUsingTheLowerOfFoesDefOrResSkill, IS_TARGET_CAVALRY_WITH_RANGE_2_NODE };
export { DOES_FOE_INITIATE_COMBAT_NODE_OR_IS_FOES_HP_GTE_75_PERCENT_AT_START_OF_COMBAT_NODE, IF_FOE_INITIATES_COMBAT_OR_IF_FOES_HP_GTE_75_PERCENT_AT_START_OF_COMBAT, IF_FOE_INITIATES_COMBAT_OR_IF_FOES_HP_GTE_50_PERCENT_AT_START_OF_COMBAT, RES_DIFF_AT_START_OF_COMBAT_NODE };
export { DEF_DIFF_DURING_COMBAT_NODE, RES_DIFF_DURING_COMBAT_NODE, setSaveSkill, setTwinSave, setBriarSave, enablesCantoRemPlus, enablesCantoRemPlusMin, enablesCantoDist, enablesCantoDistMin, enablesCantoN, enablesCantoAlly, enablesCantoAllyNM };
export { DEALS_DAMAGE_PERCENTAGE_OF_TARGETS_STAT_EXCLUDING_AOE_SPECIALS, REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_PERCENTAGE_OF_TARGETS_STAT_EXCLUDING_AOE_SPECIALS_NODE, REDUCES_DAMAGE_FROM_FOES_FIRST_ATTACK_BY_PERCENTAGE_OF_TARGETS_STAT_DURING_COMBAT_INCLUDING_TWICE_NODE, setBeastSkill };
export { CALC_POTENTIAL_DAMAGE_NODE, IS_NOT_TARGET_ADJACENT_TO_AN_ALLY, IF_UNITS_HP_GTE_25_PERCENT_AT_START_OF_COMBAT_NODE, IF_UNITS_HP_GTE_25_PERCENT_AT_START_OF_TURN_NODE, SPACES_WITHIN_M_SPACES_OF_SKILL_OWNER_WITHIN_N_SPACES_NODE };
export { setSkillThatUnitCanMoveToAnySpaceWithinNSpacesOfAnAllyWithinMSpacesOfUnit, setSkillThatAlliesWithinNSpacesOfUnitCanMoveToAnySpaceWithinMSpacesOfUnit, highestValueAmongTargetAndFoesWithinNSpacesOfTarget, HIGHEST_TOTAL_PENALTIES_AMONG_TARGET_AND_FOES_WITHIN_N_SPACES_OF_TARGET_NODE };
export { sumValueAmongTargetAndTargetsAlliesWithinNSpacesOfTarget, TOTAL_NUMBER_OF_BONUSES_AND_PENALTIES_ACTIVE_ON_FOE_AND_ANY_FOE_WITHIN_N_SPACES_OF_FOE, setSpecialCount, setSpecialCountAndType, setRefresh, setPathfinder, IS_TARGET_SKILL_OWNER_NODE, UNITS_ON_MAP_NODE };
export { SKILL_OWNERS_ALLIES_ON_MAP_NODE, SKILL_OWNER_AND_SKILL_OWNERS_ALLIES_ON_MAP_NODE, SKILL_OWNERS_ALLIES_WITHIN_N_SPACES, SKILL_OWNER_AND_SKILL_OWNERS_ALLIES_WITHIN_N_SPACES, SKILL_OWNERS_ALLIES_WITHIN_4_SPACES, SKILL_OWNERS_FOES_HAVE_HIGHEST_VALUE_ON_MAP };
export { SKILL_OWNERS_FOES_HAVE_HIGHEST_AND_THOSE_ALLIES_WITHIN_N_SPACES_ON_MAP, FILTER_MAP_UNITS_NODE, FILTER_TARGETS_ALLIES_NODE, SKILL_OWNER_AND_SKILL_OWNERS_ALLIES_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE };
export { HIGHEST_TOTAL_BONUSES_AMONG_UNIT_AND_ALLIES_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_UNIT, TOTAL_BONUSES_LIST_OF_UNIT_AND_ALLIES_WITHIN_N_SPACES_NODE, TOTAL_PENALTIES_LIST_OF_TARGET_FOE_AND_THOSE_ALLIES_WITHIN_N_SPACES_NODE, TOTAL_BONUSES_LIST_OF_TARGETS_ALLIES_ON_MAP_NODE };
export { HIGHEST_TOTAL_BONUSES_AMONG_UNIT_AND_ALLIES_WITHIN_N_SPACES_NODE, HIGHEST_TOTAL_PENALTIES_AMONG_TARGET_FOE_AND_THOSE_ALLIES_WITHIN_N_SPACES_NODE, HIGHEST_TOTAL_BONUSES_TO_TARGET_STATS_AMONG_UNIT_AND_ALLIES_WITHIN_N_SPACES_NODE };
export { HIGHEST_BONUS_ON_EACH_STAT_BETWEEN_TARGETS_ALLIES_WITHIN_N_SPACES_NODE, HIGHEST_BONUS_ON_EACH_STAT_BETWEEN_TARGET_AND_TARGETS_ALLIES_WITHIN_N_SPACES_NODE, HIGHEST_PENALTIES_ON_EACH_STAT_BETWEEN_TARGET_AND_TARGET_ALLIES_WITHIN_N_SPACES_NODE };
export { HIGHEST_PENALTY_ON_EACH_STAT_BETWEEN_TARGET_AND_TARGET_ALLIES_WITHIN_N_SPACES_NODE, HIGHEST_STATS_ON_EACH_STAT_BETWEEN_TARGET_ALLIES_WITHIN_N_SPACES_NODE, HIGHEST_STAT_ON_EACH_STAT_BETWEEN_TARGET_ALLIES_WITHIN_N_SPACES_NODE, TARGETS_PARTNERS_ON_MAP_NODE, SKILL_OWNERS_PARTNERS_ON_MAP_NODE };
export { HIGHEST_STAT_TARGETS_ALLIES_ON_MAP_NODE, HIGHEST_STAT_SKILL_OWNER_ALLIES_ON_MAP_NODE, HIGHEST_SKILL_OWNERS_ALLIES_ON_MAP_NODE, HIGHEST_TARGETS_ALLIES_WITHIN_N_SPACES_NODE, HIGHEST_TARGETS_STAT_ALLIES_WITHIN_N_SPACES_NODE, HIGHEST_TARGETS_STAT_ALLIES_WITHIN_2_SPACES_NODE };
export { SKILL_OWNERS_PARTNERS_OTHERWISE_HIGHEST_STAT_ALLIES_NODE, SKILL_OWNERS_PARTNERS_OTHERWISE_HIGHEST_TARGET_STAT_ALLIES_NODE, IS_BONUS_OR_PENALTY_ACTIVE_ON_TARGET_NODE, LOWEST_HP_UNITS_NODE, ALLIES_WITHIN_N_SPACES_OF_BOTH_ASSIST_UNIT_AND_TARGET };
export { GRANTS_STATUS_EFFECTS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_N_SPACES_NODE, GRANTS_STATUS_EFFECTS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_2_SPACES_NODE, GRANTS_STATUS_EFFECTS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_3_SPACES_NODE };
export { GRANTS_STATS_BONUS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_N_SPACES_NODE, GRANTS_STATS_BONUS_AND_STATUS_EFFECTS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_N_SPACES_NODE, GRANTS_STATS_BONUS_AND_STATUS_EFFECTS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_2_SPACES_NODE };
export { GRANTS_STATS_BONUS_AND_STATUS_EFFECTS_ON_MAP_TO_TARGET_AND_TARGET_ALLIES_WITHIN_3_SPACES_NODE, INFLICTS_STATUS_EFFECT_ON_MAP_ON_TARGETS_CLOSEST_FOE_AND_FOES_WITHIN_N_SPACES_NODE, INFLICTS_STATUS_EFFECT_ON_MAP_ON_TARGETS_CLOSEST_FOE_AND_FOES_WITHIN_2_SPACES_NODE };
export { INFLICTS_STATUS_EFFECT_ON_MAP_ON_TARGETS_CLOSEST_FOE_AND_FOES_WITHIN_3_SPACES_NODE, INFLICTS_STATS_PENALTIES_AND_STATUS_EFFECT_ON_MAP_ON_TARGETS_CLOSEST_FOE_AND_FOES_WITHIN_N_SPACES_NODE };
export { INFLICTS_STATS_PENALTIES_AND_STATUS_EFFECT_ON_MAP_ON_TARGETS_CLOSEST_FOE_AND_FOES_WITHIN_2_SPACES_NODE, INFLICTS_STATS_PENALTIES_AND_STATUS_EFFECT_ON_MAP_ON_TARGETS_FOES_WITH_PRED_AND_THAT_ARE_WITHIN_N_SPACES_OF_ANOTHER_FOR_NODE };
export { INFLICTS_STATS_PENALTIES_AND_STATUS_EFFECT_ON_MAP_ON_TARGETS_FOES_WITH_PRED_AND_THAT_ARE_WITHIN_2_SPACES_OF_ANOTHER_FOR_NODE, INFLICTS_STATS_PENALTIES_AND_STATUS_EFFECT_ON_MAP_ON_TARGETS_FOES_WITH_PRED_AND_THAT_ARE_WITHIN_3_SPACES_OF_ANOTHER_FOR_NODE };
export { INFLICTS_STATS_PENALTIES_AND_STATUS_EFFECT_ON_MAP_ON_TARGETS_CLOSEST_FOE_AND_FOES_WITHIN_3_SPACES_NODE, setFortune, setSlyEffect, setEffectThatTransformationEffectsGainAdditionalTriggerCondition, setEffectThatIfDefendingInARAtStartOfEnemyTurn1UnitTransforms };
export { NUM_OF_TARGETS_FOES_THAT_HAVE_ALREADY_PERFORMED_ACTION, GRANTS_EFFECTIVE_AGAINST_ALL_WEAPON_TYPES_TO_UNIT_DURING_COMBAT, setRallyHealSkill, setSpikedWall, TOTAL_OF_THE_NUMBER_OF_DISTINCT_GAME_TITLES_AMONG_UNITS_NODE };
export { NUMBER_OF_DISTINCT_GAME_TITLES_AMONG_ALLIES_WITHIN_N_SPACES_OF_UNIT_NODE, setSway, setCannotMoveThroughSpacesSkill, INFLICTS_SPECIAL_COOLDOWN_COUNT_1_ON_FOE_BEFORE_FOES_FIRST_ATTACK_DURING_COMBAT_BY_DRAGON_NODE, grantsAnotherActionAfterCanto, setResonance };
export { setAllEffectsForSkillOwnersAlliesDuringCombatHooks, setAtStartOfCombatHooks, setAtStartOfCombatAndAfterStatsDeterminedHooks, setBeforeAoeSpecialAtStartOfCombatAndAfterStatsDeterminedHooks, setForFoesSkillsDuringCombatHooks, setWhenUnitIsInCombatFoesSaviorEffectsWillNotTriggerNode };
export { setAtStartOfPlayerPhaseOrEnemyPhase, setAtStartOfPlayerPhaseOrEnemyPhaseExceptForInSummonerDuels, setAtStartOfEnemyPhaseExceptForInPawnsOfLoki, setAtStartOfEnemyPhaseAfterHealingAndDamageSkillsExceptForInPawnsOfLoki, setAtStartOfPlayerPhaseOrAfterActsIfCantoAfterCanto };
export { setAfterStartOfTurnEffectsTriggerOnPlayerOrEnemyPhaseHooks, setAfterStartOfTurnEffectsTriggerOnPlayerOrEnemyPhaseExceptForInSummonerDuelsHooks, setCondHooks, setIfRallyOrMovementAssistSkillIsUsedByUnit, setIfRallyOrMovementAssistSkillIsUsedByUnitOrTargetsUnit };
export { setIfRallyOrMovementAssistSkillEndedByUnit, setAtStartOfTurnAndAfterUnitActsIfCantoAfterCanto, setOnceUsedThisStyleCannotBeUsedForNTurns, setStyleRange, setUnitCanUseFollowingStyle };
export { HIGHEST_HP_AMONG_SKILL_OWNERS_ALLIES };
