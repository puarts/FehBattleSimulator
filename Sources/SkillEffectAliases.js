...
const HIGHEST_ATK_SKILL_OWNERS_ALLIES_ON_MAP_NODE = MAX_UNITS_NODE(SKILL_OWNERS_ALLIES_ON_MAP_NODE, TARGETS_ATK_ON_MAP);
const HIGHEST_SPD_SKILL_OWNERS_ALLIES_ON_MAP_NODE = MAX_UNITS_NODE(SKILL_OWNERS_ALLIES_ON_MAP_NODE, TARGETS_SPD_ON_MAP);
const HIGHEST_DEF_SKILL_OWNERS_ALLIES_ON_MAP_NODE = MAX_UNITS_NODE(SKILL_OWNERS_ALLIES_ON_MAP_NODE, TARGETS_DEF_ON_MAP);
const HIGHEST_RES_SKILL_OWNERS_ALLIES_ON_MAP_NODE = MAX_UNITS_NODE(SKILL_OWNERS_ALLIES_ON_MAP_NODE, TARGETS_RES_ON_MAP);
const HIGHEST_HP_SKILL_OWNERS_ALLIES_ON_MAP_NODE = MAX_UNITS_NODE(SKILL_OWNERS_ALLIES_ON_MAP_NODE, TARGETS_HP_ON_MAP_NODE);
