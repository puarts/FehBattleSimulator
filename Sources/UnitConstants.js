...
const Hero = {
    ...
    DuoIke: 805,
    HarmonizedRoy: 823,
    HarmonizedEdelgard: 837,
    DuoThorr: 843,
    DuoNina: 855,
    HarmonizedTana: 868,
    DuoDuma: 881,
    DuoLaegijarn: 895,
    HarmonizedCordelia: 916,
    DuoAskr: 922,
    HarmonizedLinde: 927,
    DuoElise: 940,
    HarmonizedKarla: 952,
    ...
    DuoByleth: 1070,
    DuoSeidr: 1076,
    HarmonizedIgrene: 1087,
    DuoLyon: 1094,
    HarmonizedChloe: 1105,
    DuoRobin: 1117,
    DuoSharena: 1133,
    DuoGullveig: 1144,
    HarmonizedGoldmary: 1151,
    HarmonizedNephenee: 1165,
    DuoFjorm: 1177,
    HarmonizedNagi: 1189,
    DuoLucina: 1201,
    DuoAlear: 1222,
    DuoHeidrun: 1228,
    HarmonizedMarisa: 1238,
    DuoRhea: 1245,
    HarmonizedPlumeria: 1256,
    DuoCorrinM: 1267,
    DuoMarth: 1274,
    DuoJulia: 1284,
    HarmonizedCelica: 1296,
    DuoHapi: 1302,
    HarmonizedIngrid: 1317,
    HarmonizedFir: 1330,
    DuoFreyja: 1344,
    DuoElincia: 1348,
    DuoGullveigNinja: 1356,
    HarmonizedIke: 1361,
    HarmonizedRyn: 1362,
    HarmonizedIvy: 1373,
    DuoBaldr: 1379,
    HarmonizedHilda: 1388,
    DuoBraveHector: 1395,
    DuoBraveCelica: 1396,
...
const EntwinedType = Object.freeze({
    ...
    Ash: Object.freeze({id: 1, value: [2, 0, 2, 0], text: "アシュ", heroId: 1336}),
    Sharena: Object.freeze({id: 2, value: [2, 2, 0, 0], text: "シャロン", heroId: 1349}),
});

const HeroIdToEntwinedType = new Map(
    Object.values(EntwinedType)
        .filter(entry => entry.heroId !== undefined)
        .map(entry => [entry.heroId, entry])
);
...
function isThiefId(heroId) {
    return heroId === Hero.Thief ||
        heroId === Hero.RedThief ||
        heroId === Hero.BlueThief ||
        heroId === Hero.GreenThief;
}
