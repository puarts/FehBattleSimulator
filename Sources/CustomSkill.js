import { ACCELERATES_SPECIAL_TRIGGER_SET, AssistType, CantoSupport, EFFECTIVE_TYPE_NAMES, EffectiveType, NONE_ID, SKILL_IDS_THAT_SKILLS_EFFECTS_RANGE_IS_TREATED_AS_1, SKILL_IDS_THAT_SKILLS_EFFECTS_RANGE_IS_TREATED_AS_2, SkillType, Weapon, getAssistTypeName, getCantoAssistName } from './SkillConstants.js';
import { ADD_NODE, AND_NODE, CONSTANT_NUMBER_NODE, ConstantNumberNode, ENSURE_MIN_MAX_NODE, GTE_NODE, IF_NODE, MULT_NODE, MultiValueMap, NODE_FUNC, NumberNode, SET_SKILL_FUNCS, SKILL_EFFECT_NODE, SkillEffectNode, TRUE_NODE, ZERO_NUMBER_NODE, setCustomSkillRegistry } from './SkillEffectCore.js';
import { AFTER_ACTION_WITHOUT_COMBAT_FOR_ANOTHER_ACTION_HOOKS, AFTER_BEING_GRANTED_ANOTHER_ACTION_ON_ASSIST_HOOKS, AFTER_CANCEL_FOES_ATTACK_HOOKS, AFTER_COMBAT_EVEN_IF_DEFEATED_HOOKS, AFTER_COMBAT_FOR_ALLIES_EVEN_IF_DEFEATED_HOOKS, AFTER_COMBAT_FOR_ANOTHER_ACTION_HOOKS, AFTER_COMBAT_HOOKS, AFTER_COMBAT_IF_UNIT_ATTACKED_HOOKS, AFTER_START_OF_TURN_EFFECTS_TRIGGER_ON_ENEMY_PHASE_HOOKS, AFTER_START_OF_TURN_EFFECTS_TRIGGER_ON_PLAYER_PHASE_HOOKS, AFTER_UNIT_ACTS_IF_CANTO_TRIGGERS_AFTER_CANTO_HOOKS, AT_APPLYING_ONCE_PER_COMBAT_DAMAGE_REDUCTION_HOOKS, AT_START_OF_ATTACK_HOOKS, AT_START_OF_COMBAT_HOOKS, AT_START_OF_ENEMY_PHASE_HOOKS, AT_START_OF_TURN_HOOKS, BEFORE_AOE_SPECIAL_ACTIVATION_CHECK_HOOKS, BEFORE_AOE_SPECIAL_HOOKS, CANCEL_FOES_ATTACK_HOOKS, CAN_ATTACK_FOES_N_SPACES_AWAY_HOOKS, CAN_RALLIED_FORCIBLY_HOOKS, CAN_RALLY_FORCIBLY_HOOKS, FOR_FOES_AT_START_OF_COMBAT_HOOKS, HAS_PATHFINDER_HOOKS, IS_AFFLICTOR_HOOKS, IS_DEBUFFER_TIER_1_HOOKS, IS_DEBUFFER_TIER_2_HOOKS, NON_STATS_SKILL_USING_STATS_HOOKS, STATS_SKILL_USING_STATS_HOOKS, WHEN_APPLIES_SPECIAL_EFFECTS_AT_START_OF_COMBAT_HOOKS, WHEN_CANTO_ALLY_CAN_MOVE_TO_A_SPACE_HOOKS, WHEN_CANTO_TRIGGERS_HOOKS } from './SkillEffectHooks.js';
import { APPLY_DIVINE_VEIN_NODE, ASSIST_TARGET_NODE, ATK, ATK_DEF, ATK_DEF_RES, ATK_RES, ATK_SPD, ATK_SPD_DEF, ATK_SPD_DEF_RES, ATK_SPD_RES, CAN_FOES_ATTACK_TRIGGER_FOES_SPECIAL_NODE, CONVERTS_BONUSES_ON_TARGET_INTO_PENALTIES_NODE, CONVERTS_PENALTIES_ON_TARGET_INTO_BONUSES_NODE, DEF, DEF_RES, DESTROYS_OFFENCE_SAFETY_FENCE_NODE, EMPTY_SPACES_NODE, ENABLES_TARGET_TO_USE_CANTO_ASSIST_ON_TARGETS_ALLY_NODE, ENDS_TARGETS_ACTION_BY_STATUS_EFFECT_NODE, FOES_ATK_AT_START_OF_COMBAT_NODE, FOES_DEF_AT_START_OF_COMBAT_NODE, FOES_EVAL_RES_DURING_COMBAT_NODE, FOES_RES_AT_START_OF_COMBAT_NODE, FOES_SPD_AT_START_OF_COMBAT_NODE, FOR_EACH_SPACES_NODE, FOR_EACH_UNIT_NODE, GRANTS_ADDITIONAL_STAT_BONUS_TO_EACH_STAT_NODE, GRANTS_ANOTHER_ACTION_TO_TARGET_ONCE_PER_TURN_ON_ASSIST_NODE, GRANTS_STATS_PLUS_TO_TARGET_DURING_COMBAT_NODE, GRANTS_STATS_PLUS_TO_TARGET_ON_MAP_NODE, GRANTS_STATUS_EFFECTS_ON_TARGET_ON_MAP_NODE, HAS_TARGET_STATUS_EFFECT_NODE, INFLICTS_STATS_MINUS_ON_FOE_DURING_COMBAT_NODE, INFLICTS_STATS_MINUS_ON_TARGET_ON_MAP_NODE, IS_TARGET_WITHIN_3_ROWS_OR_3_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE, IS_TARGET_WITHIN_6_SPACES_OF_SKILL_OWNER_NODE, IS_THE_UNITS_OR_FOES_SPECIAL_READY_OR_WAS_THE_UNITS_OR_FOES_SPECIAL_TRIGGERED_BEFORE_OR_DURING_THIS_COMBAT, NEUTRALIZES_ANY_BONUSES_ON_TARGET_NODE, NEUTRALIZES_ANY_PENALTY_ON_TARGET_NODE, NEUTRALIZES_TARGETS_N_BONUS_EFFECTS_NODE, NEUTRALIZES_TARGETS_N_PENALTY_EFFECTS_NODE, N_SPACES_IN_A_LINE_CENTERED_ON_TARGETS_FOES_SPACE_ORIENTED_LEFT_TO_RIGHT_BASED_ON_THE_DIRECTION_TARGET_IS_FACING_NODE, PLACED_SPACES, REMOVE_UNITS_NODE, RES, RESTORE_TARGETS_HP_ON_MAP_NODE, SKILL_OWNER_NODE, SPACES_IF_NODE, SPACES_WITHIN_N_SPACES_OF_FOE_NODE, SPACES_WITHIN_N_SPACES_OF_SKILL_OWNER_NODE, SPACES_WITHIN_N_SPACES_OF_SPACES_NODE, SPACES_WITHIN_N_SPACES_OF_TARGET_NODE, SPD, SPD_DEF, SPD_DEF_RES, SPD_RES, StatsNode, TARGETS_FOES_ON_MAP_NODE, TARGET_AND_TARGETS_ALLIES_ON_MAP_NODE, TARGET_AND_TARGETS_ALLIES_WITHIN_N_SPACES_NODE, TARGET_GROUP_NODE, TARGET_NODE, UNITS_ATK_AT_START_OF_COMBAT_NODE, UNITS_DEF_AT_START_OF_COMBAT_NODE, UNITS_EVAL_RES_DURING_COMBAT_NODE, UNITS_RES_AT_START_OF_COMBAT_NODE, UNITS_SPD_AT_START_OF_COMBAT_NODE, UnitsNode, ZERO_STATS_NODE } from './SkillEffect.js';
...
import { ALLIES_WITHIN_N_SPACES_OF_BOTH_ASSIST_UNIT_AND_TARGET, CLOSEST_FOES_WITHIN_5_SPACES_OF_BOTH_ASSIST_TARGETING_AND_ASSIST_TARGET_AND_FOES_WITHIN_2_SPACES_OF_THOSE_FOES_NODE, DEALS_DAMAGE_X_NODE, FOES_ATK_NODE, FOES_DEF_NODE, FOES_RES_NODE, FOES_SPD_NODE, FOE_CANNOT_TRIGGER_SPECIALS_DURING_COMBAT_NODE, HIGHEST_TOTAL_PENALTIES_AMONG_TARGET_AND_FOES_WITHIN_N_SPACES_OF_TARGET_NODE, PERCENTAGE_NODE, REDUCES_DAMAGE_BY_N_NODE, SKILL_OWNERS_ALLIES_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE, SKILL_OWNERS_FOES_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE, SKILL_OWNER_AND_SKILL_OWNERS_ALLIES_WITHIN_N_ROWS_OR_N_COLUMNS_CENTERED_ON_SKILL_OWNER_NODE, TARGETS_CLOSEST_FOES_AND_FOES_ALLIES_WITHIN_N_SPACES_OF_THOSE_FOES_NODE, TARGETS_CLOSEST_FOES_NODE, TOTAL_NUMBER_OF_BONUSES_AND_PENALTIES_ACTIVE_ON_FOE_AND_ANY_FOE_WITHIN_N_SPACES_OF_FOE, UNITS_ATK_NODE, UNITS_DEF_NODE, UNITS_ON_MAP_NODE, UNITS_RES_NODE, UNITS_SPD_NODE, UNIT_CANNOT_TRIGGER_SPECIALS_DURING_COMBAT_NODE, setAfterStartOfTurnEffectsTriggerOnPlayerOrEnemyPhaseHooks, setAtStartOfPlayerPhaseOrAfterActsIfCantoAfterCanto, setAtStartOfPlayerPhaseOrEnemyPhase, setAtStartOfPlayerPhaseOrEnemyPhaseExceptForInSummonerDuels, setDivineNectarAnotherActionSkill, setIfRallyOrMovementAssistSkillEndedByUnit, setIfRallyOrMovementAssistSkillIsUsedByUnit, setIfRallyOrMovementAssistSkillIsUsedByUnitOrTargetsUnit } from './SkillEffectAliases.js';
import { BOOSTS_DAMAGE_WHEN_SPECIAL_TRIGGERS_NODE, CANCELS_STATUS_EFFECTS_GRANTED_TO_TARGET_NODE, EFFECTIVE_AGAINST_NODE, FOE_CANNOT_COUNTERATTACK_NODE, FOE_CANNOT_MAKE_FOLLOW_UP_ATTACK_NODE, FOE_CANNOT_RECOVER_HP_DURING_COMBAT_NODE, FOE_CANNOT_TRIGGER_AREA_OF_EFFECT_SPECIALS_NODE, FOE_CANNOT_TRIGGER_ATTACKER_SPECIAL, FOE_CANNOT_TRIGGER_DEFENDER_SPECIAL, GRANTS_SPECIAL_COOLDOWN_CHARGE_PLUS_1_TO_UNIT_PER_ATTACK_DURING_COMBAT_NODE, GRANTS_SPECIAL_COOLDOWN_COUNT_MINUS_N_TO_TARGET_BEFORE_TARGETS_FIRST_FOLLOW_UP_ATTACK_DURING_COMBAT_NODE, GRANTS_SPECIAL_COOLDOWN_COUNT_MINUS_N_TO_TARGET_BEFORE_TARGETS_FOES_FIRST_ATTACK_DURING_COMBAT_NODE, INCREASES_SPD_DIFF_NECESSARY_FOR_TARGETS_FOES_TO_MAKE_FOLLOW_UP_NODE, INFLICTS_SPECIAL_COOLDOWN_CHARGE_MINUS_1_ON_FOE_NODE, INFLICTS_SPECIAL_COOLDOWN_COUNT_PLUS_N_ON_TARGETS_FOE_BEFORE_TARGETS_FIRST_ATTACK_NODE, INFLICTS_SPECIAL_COOLDOWN_COUNT_PLUS_N_ON_TARGETS_FOE_BEFORE_TARGETS_FOES_FIRST_ATTACK_NODE, INFLICTS_SPECIAL_COOLDOWN_COUNT_PLUS_N_ON_TARGETS_FOE_BEFORE_TARGETS_FOES_FIRST_FOLLOW_UP_ATTACK_NODE, INFLICTS_SPECIAL_COOLDOWN_COUNT_PLUS_N_ON_TARGETS_FOE_BEFORE_TARGETS_FOES_SECOND_STRIKE_NODE, NEUTRALIZES_EFFECTS_THAT_GRANT_SPECIAL_COOLDOWN_CHARGE_PLUS_X_TO_FOE, NEUTRALIZES_EFFECTS_THAT_INFLICT_SPECIAL_COOLDOWN_CHARGE_MINUS_X_ON_UNIT, NEUTRALIZES_EFFECTS_THAT_PREVENT_TARGETS_COUNTERATTACKS_DURING_COMBAT_NODE, NEUTRALIZES_FOES_BONUSES_TO_STATS_DURING_COMBAT_NODE, NEUTRALIZES_PENALTIES_ON_UNIT_NODE, NEUTRALIZES_TARGET_FOES_NON_SPECIAL_MIRACLE, REDUCES_DAMAGE_BEFORE_COMBAT_NODE, REDUCES_DAMAGE_FROM_FOES_FIRST_ATTACK_BY_N_DURING_COMBAT_INCLUDING_TWICE_NODE, REDUCES_DAMAGE_FROM_FOES_FIRST_ATTACK_BY_N_PERCENT_DURING_COMBAT_INCLUDING_TWICE_NODE, REDUCES_DAMAGE_FROM_FOES_FIRST_ATTACK_BY_N_PERCENT_DURING_COMBAT_NODE, REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_PERCENT_BY_SPECIAL_NODE, REDUCES_DAMAGE_FROM_TARGETS_FOES_ATTACKS_BY_X_PERCENT_DURING_COMBAT_NODE, REDUCES_DAMAGE_FROM_TARGETS_FOES_CONSECUTIVE_ATTACKS_BY_X_PERCENT_DURING_COMBAT_NODE, REDUCES_DAMAGE_FROM_TARGETS_FOES_NEXT_ATTACK_BY_N_PERCENT_ONCE_PER_COMBAT_NODE, REDUCES_DAMAGE_FROM_TARGETS_FOES_SECOND_STRIKE_OF_FIRST_ATTACK_BY_N_DURING_COMBAT_NODE, REDUCES_DAMAGE_FROM_TARGET_FOES_FOLLOW_UP_ATTACK_BY_X_PERCENT_DURING_COMBAT_NODE, REDUCES_DAMAGE_WHEN_FOES_SPECIAL_EXCLUDING_AOE_SPECIAL_NODE, REDUCES_EFFECT_OF_DEEP_WOUNDS_ON_TARGET_BY_X_PERCENT_DURING_COMBAT_NODE, REDUCES_PERCENTAGE_OF_TARGETS_FOES_NON_SPECIAL_DAMAGE_REDUCTION_BY_N_PERCENT_DURING_COMBAT_NODE, RESTORES_N_HP_TO_UNIT_AFTER_COMBAT_NODE, TARGET_ATTACKS_TWICE_EVEN_IF_TARGETS_FOE_INITIATES_COMBAT_NODE, TARGETS_FIRST_FOLLOW_UP_ATTACK_DEALS_X_DAMAGE_NODE, TARGETS_NEXT_ATTACK_DEALS_DAMAGE_EQ_TOTAL_DAMAGE_REDUCED_FROM_TARGETS_FOES_FIRST_ATTACK_NODE, TARGETS_NEXT_ATTACK_DEALS_DAMAGE_X_PERCENT_OF_TARGETS_FORES_ATTACK_PRIOR_TO_REDUCTION_ONLY_HIGHEST_VALUE_APPLIED_AND_DOES_NOT_STACK_NODE, TARGET_ATTACKS_TWICE_WHEN_TARGETS_FOE_INITIATES_COMBAT_NODE, TARGET_ATTACKS_TWICE_WHEN_TARGET_INITIATES_COMBAT_NODE, TARGET_CAN_ACTIVATE_NON_SPECIAL_MIRACLE_NODE, TARGET_CAN_COUNTERATTACK_BEFORE_TARGETS_FOES_FIRST_ATTACK_NODE, TARGET_NEUTRALIZES_EFFECTIVE_AGAINST_X_NODE, UNIT_CANNOT_TRIGGER_AREA_OF_EFFECT_SPECIALS_NODE, UNIT_CANNOT_TRIGGER_ATTACKER_SPECIAL, UNIT_CANNOT_TRIGGER_DEFENDER_SPECIAL, UNIT_CAN_MAKE_FOLLOW_UP_ATTACK_BEFORE_FOES_NEXT_ATTACK_NODE, UNIT_GRANTS_SPECIAL_COOLDOWN_MINUS_1_TO_UNIT_BEFORE_UNITS_FIRST_ATTACK_NODE, UNIT_MAKES_GUARANTEED_FOLLOW_UP_ATTACK_NODE, UNIT_NEUTRALIZES_EFFECTS_THAT_GUARANTEE_FOES_FOLLOW_UP_ATTACKS_DURING_COMBAT_NODE, UNIT_NEUTRALIZES_EFFECTS_THAT_PREVENT_UNITS_FOLLOW_UP_ATTACKS_DURING_COMBAT, WHEN_SPECIAL_TRIGGERS_NEUTRALIZES_FOES_REDUCES_DAMAGE_BY_PERCENTAGE_EFFECTS_FROM_FOES_NON_SPECIAL_EXCLUDING_AOE_SPECIALS_NODE, WHEN_TARGET_DEALS_DAMAGE_DURING_COMBAT_RESTORES_N_HP_PER_ATTACK_TO_TARGET_NODE } from './SkillEffectBattleContext.js';
import { CAN_MOVE_THROUGH_FOES_SPACE_SKILLS } from './Skill.js';
    ...
    static Arg = class {
        ...
        static {
            ...
            this.STAT_N_NODES = new Map([
                ...
                ['def-n', [DEF, '守備']],
                ['res-n', [RES, '魔防']],
                ['atk-spd-n', [ATK_SPD, '攻撃、速さ']],
                ['atk-def-n', [ATK_DEF, '攻撃、守備']],
                ['atk-res-n', [ATK_RES, '攻撃、魔防']],
                ['spd-def-n', [SPD_DEF, '速さ、守備']],
                ['spd-res-n', [SPD_RES, '速さ、魔防']],
                ['def-res-n', [DEF_RES, '守備、魔防']],
                ['atk-spd-def-n', [ATK_SPD_DEF, '攻撃、速さ、守備']],
                ['atk-spd-res-n', [ATK_SPD_RES, '攻撃、速さ、魔防']],
                ['atk-def-res-n', [ATK_DEF_RES, '攻撃、守備、魔防']],
                ['spd-def-res-n', [SPD_DEF_RES, '速さ、守備、魔防']],
                ['atk-spd-def-res-n', [ATK_SPD_DEF_RES, '攻撃、速さ、守備、魔防']],
            ]);
