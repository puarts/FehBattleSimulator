@echo off
set TMP_TEST_JS=%1
set SOURCE_FILE_NAMES=GlobalDefinitions,Utilities,Logger,Skill,BattleMapElement,Tile,BattleMap,Structures,Cell,Table,HeroInfo,Unit,UnitManager,GlobalBattleContext,DamageCalculationUtility,DamageCalculator,PostCombatSkillHander,DamageCalculatorWrapper,combat\DamageCalculatorWrapper_InitSkillEffectDict_AtkDef,combat\DamageCalculatorWrapper_InitSkillEffectDict_Unit,combat\DamageCalculatorWrapper_ApplySkillEffects,combat\DamageCalculatorWrapper_Spur,combat\DamageCalculatorWrapper_FollowupAndCounter,BeginningOfTurnSkillHandler,TurnSetting,AudioManager,AetherRaidDefensePresets,SkillDatabase,HeroDatabase
