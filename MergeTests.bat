@echo off
set TMP_TEST_JS=%1
set SOURCE_FILE_NAMES=GlobalDefinitions,Utilities,Logger,Skill,Tile,Map,Structures,Cell,Table,HeroInfo,Unit,UnitManager,GlobalBattleContext,DamageCalculationUtility,DamageCalculator,PostCombatSkillHander,DamageCalculatorWrapper,TurnSetting,AudioManager,AetherRaidDefensePresets,SkillDatabase,HeroDatabase
