...
Generate content for section `section-04-spur-split` (filename: `section-04-spur-split.md`).
...
for `section-04-spur-split` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/damage-calc-wrapper-split/sections/section-04-spur-split.md`
