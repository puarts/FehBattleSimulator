...
Generate content for section `section-03-apply-skill-effects-split` (filename: `section-03-apply-skill-effects-split.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/damage-calc-wrapper-split/claude-plan.md` - Full implementation plan
2. `/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/damage-calc-wrapper-split/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/damage-calc-wrapper-split/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-apply-skill-effects-split` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/damage-calc-wrapper-split/sections/section-03-apply-skill-effects-split.md`
