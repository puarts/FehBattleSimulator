...
Generate content for section `section-02-init-dict-split` (filename: `section-02-init-dict-split.md`).
...
for `section-02-init-dict-split` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/damage-calc-wrapper-split/sections/section-02-init-dict-split.md`
