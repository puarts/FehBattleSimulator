...
Generate content for section `section-06-final-verification` (filename: `section-06-final-verification.md`).
...
for `section-06-final-verification` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/damage-calc-wrapper-split/sections/section-06-final-verification.md`
