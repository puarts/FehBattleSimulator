...
Generate content for section `section-01-preparation` (filename: `section-01-preparation.md`).
...
for `section-01-preparation` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/damage-calc-wrapper-split/sections/section-01-preparation.md`
