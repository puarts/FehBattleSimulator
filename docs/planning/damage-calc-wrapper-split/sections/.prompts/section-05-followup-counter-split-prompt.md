...
Generate content for section `section-05-followup-counter-split` (filename: `section-05-followup-counter-split.md`).
...
for `section-05-followup-counter-split` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/damage-calc-wrapper-split/sections/section-05-followup-counter-split.md`
