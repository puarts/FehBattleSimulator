...
index 81a80fa0..b2e2f99e 100644
--- a/Deploy.bat
+++ b/Deploy.bat
@@ -20,6 +20,7 @@ set BF=%BF%,data\HeroInfoConstants,data\HeroInfo,data\UnitConstants,unit\BattleC
 rem �v�Z���W�b�N
...
index e420e607..4070cd8e 100644
...
index 4d118c3c..56266c0e 100644
...
index 6d1df987..e329c750 100644
...
index 5f465f83..4433bea1 100644
...
index 0db44f4b..7b7ac8a3 100644
...
-    }
     ...
     /**
      * @param {Unit} targetUnit
@@ -2060,250 +1823,6 @@ class DamageCalculatorWrapper {
         }
     }
...
-    }
     ...
     /**
      * @param  {Unit} targetUnit
@@ -4182,927 +3701,15 @@ class DamageCalculatorWrapper {
...
@@ -7034,422 +5641,6 @@ class DamageCalculatorWrapper {
     }
...
-    }
      ...
      * @param  {Unit} targetUnit
      * @param  {Number} spaces
diff --git a/Sources/combat/DamageCalculatorWrapper_ApplySkillEffects.js b/Sources/combat/DamageCalculatorWrapper_ApplySkillEffects.js
new file mode 100644
index 00000000..c9c489ab
--- /dev/null
+++ b/Sources/combat/DamageCalculatorWrapper_ApplySkillEffects.js
@@ -0,0 +1,1818 @@
...
index bbf32f4c..d654537d 100644
...
index 08a09360..cb72614a 100755
--- a/create_tests.sh
+++ b/create_tests.sh
@@ -29,6 +29,7 @@ SOURCE_FILE_NAMES=(
     combat/DamageCalculatorWrapper
