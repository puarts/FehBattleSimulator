...
Generate content for section `section-04-unit-utility` (filename: `section-04-unit-utility.md`).
...
for `section-04-unit-utility` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/large-file-split/sections/section-04-unit-utility.md`
