...
Generate content for section `section-02-scoped-tile-changer` (filename: `section-02-scoped-tile-changer.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/large-file-split/claude-plan.md` - Full implementation plan
2. `/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/large-file-split/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/large-file-split/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-scoped-tile-changer` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/large-file-split/sections/section-02-scoped-tile-changer.md`
