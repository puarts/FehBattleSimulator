...
index f1cf11a7..aaa87f19 100644
...
index d82121bb..af0bda2f 100644
...
index 43aedf08..a5fa34ff 100644
...
index 95ed7bf1..c4998239 100644
...
index cee58527..2d601469 100644
...
index 8cbd6d6d..9b53b4fa 100644
--- a/Sources/Unit.js
+++ b/Sources/Unit.js
@@ -1,7448 +1,18 @@
...
+    isThief, calcArenaBaseStatusScore, calcArenaTotalSpScore, canRefreshTo,
+} from './UnitCore.js';
...
+export { calcBuffAmount } from './UnitBattle.js';
...
diff --git a/Sources/UnitBattle.js b/Sources/UnitBattle.js
new file mode 100644
index 00000000..1edeb0f1
--- /dev/null
+++ b/Sources/UnitBattle.js
@@ -0,0 +1,881 @@
...
+initUnitSkillEffects(Unit);
 ...
 class UnitBuilderMain extends BattleSimulatorBase {
     constructor() {
diff --git a/Sources/UnitCore.js b/Sources/UnitCore.js
new file mode 100644
index 00000000..385c141f
--- /dev/null
+++ b/Sources/UnitCore.js
@@ -0,0 +1,5860 @@
+import LZString from 'lz-string';
+import { ObjectUtil, MathUtil, ArrayUtil } from './Utilities.js';
+import { BattleMapElement } from './BattleMapElement.js';
...
+
+    /**
+     * addStatusEffectの内部実装（#statusEffectsへの追加）。
+     * @param {number} statusEffectType
+     */
+    _addStatusEffectRaw(statusEffectType) {
+        if (!this.hasStatusEffect(statusEffectType)) {
+            this.#statusEffects.push(statusEffectType);
+        }
+    }
...
+
+export { Unit, AttackableUnitInfo, AttackEvaluationContext, AssistableUnitInfo, ActionContext, PrecombatContext, UnitUtil };
+export { isThief, calcArenaBaseStatusScore, calcArenaTotalSpScore, canRefreshTo };
\ No newline at end of file
diff --git a/Sources/UnitSkillEffect.js b/Sources/UnitSkillEffect.js
new file mode 100644
index 00000000..31addee2
--- /dev/null
...
+import { applySkillsAfterCantoActivatedFuncMap, applyEndActionSkillsFuncMap } from './Skill.js';
+import { isMeleeWeaponType } from './Skill.js';
+import { calcMoveCountForCantoFuncMap } from './Skill.js';
+
+/**
...
+    });
+});
diff --git a/scripts/split-unit.mjs b/scripts/split-unit.mjs
new file mode 100644
index 00000000..46d647fd
--- /dev/null
+++ b/scripts/split-unit.mjs
@@ -0,0 +1,471 @@
+#!/usr/bin/env node
+/**
...
index 094a7c8e..de78184b 100644
--- a/vitest.setup.js
+++ b/vitest.setup.js
