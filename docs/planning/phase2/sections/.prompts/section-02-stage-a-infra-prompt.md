...
Generate content for section `section-02-stage-a-infra` (filename: `section-02-stage-a-infra.md`).
...
for `section-02-stage-a-infra` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase2/sections/section-02-stage-a-infra.md`
