...
Generate content for section `section-04-stage-c-data` (filename: `section-04-stage-c-data.md`).
...
for `section-04-stage-c-data` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase2/sections/section-04-stage-c-data.md`
