...
Generate content for section `section-03-stage-b-constants` (filename: `section-03-stage-b-constants.md`).
...
for `section-03-stage-b-constants` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase2/sections/section-03-stage-b-constants.md`
