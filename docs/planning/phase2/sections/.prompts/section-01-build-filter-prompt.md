...
Generate content for section `section-01-build-filter` (filename: `section-01-build-filter.md`).
...
for `section-01-build-filter` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase2/sections/section-01-build-filter.md`
