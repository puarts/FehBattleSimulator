...
Generate content for section `section-09-stage-h-combat` (filename: `section-09-stage-h-combat.md`).
...
for `section-09-stage-h-combat` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase2/sections/section-09-stage-h-combat.md`
