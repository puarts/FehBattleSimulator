...
Generate content for section `section-11-esm-validation` (filename: `section-11-esm-validation.md`).
...
for `section-11-esm-validation` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase2/sections/section-11-esm-validation.md`
