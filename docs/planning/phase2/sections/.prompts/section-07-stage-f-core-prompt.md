...
Generate content for section `section-07-stage-f-core` (filename: `section-07-stage-f-core.md`).
...
for `section-07-stage-f-core` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase2/sections/section-07-stage-f-core.md`
