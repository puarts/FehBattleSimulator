...
Generate content for section `section-07-combat-logic-tests` (filename: `section-07-combat-logic-tests.md`).
...
for `section-07-combat-logic-tests` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/testing/sections/section-07-combat-logic-tests.md`
