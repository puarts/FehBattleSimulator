...
Generate content for section `section-06-skill-regression-tests` (filename: `section-06-skill-regression-tests.md`).
...
for `section-06-skill-regression-tests` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/testing/sections/section-06-skill-regression-tests.md`
