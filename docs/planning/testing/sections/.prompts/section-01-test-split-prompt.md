...
Generate content for section `section-01-test-split` (filename: `section-01-test-split.md`).
...
for `section-01-test-split` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/testing/sections/section-01-test-split.md`
