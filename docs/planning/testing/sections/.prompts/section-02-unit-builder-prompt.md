...
Generate content for section `section-02-unit-builder` (filename: `section-02-unit-builder.md`).
...
for `section-02-unit-builder` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/testing/sections/section-02-unit-builder.md`
