...
Generate content for section `section-03-battle-scenario-builder` (filename: `section-03-battle-scenario-builder.md`).
...
for `section-03-battle-scenario-builder` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/testing/sections/section-03-battle-scenario-builder.md`
