...
Generate content for section `section-04-directory-design` (filename: `section-04-directory-design.md`).
...
for `section-04-directory-design` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/esm-migration/sections/section-04-directory-design.md`
