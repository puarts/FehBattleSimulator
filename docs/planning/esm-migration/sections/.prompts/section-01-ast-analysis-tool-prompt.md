...
Generate content for section `section-01-ast-analysis-tool` (filename: `section-01-ast-analysis-tool.md`).
...
for `section-01-ast-analysis-tool` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/esm-migration/sections/section-01-ast-analysis-tool.md`
