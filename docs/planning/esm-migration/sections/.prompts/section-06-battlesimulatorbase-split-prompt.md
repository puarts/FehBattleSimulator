...
Generate content for section `section-06-battlesimulatorbase-split` (filename: `section-06-battlesimulatorbase-split.md`).
...
for `section-06-battlesimulatorbase-split` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/esm-migration/sections/section-06-battlesimulatorbase-split.md`
