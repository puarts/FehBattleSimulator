...
Generate content for section `section-03-strict-mode` (filename: `section-03-strict-mode.md`).
...
for `section-03-strict-mode` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/esm-migration/sections/section-03-strict-mode.md`
