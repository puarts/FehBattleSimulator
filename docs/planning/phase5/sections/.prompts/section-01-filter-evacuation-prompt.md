...
Generate content for section `section-01-filter-evacuation` (filename: `section-01-filter-evacuation.md`).
...
for `section-01-filter-evacuation` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase5/sections/section-01-filter-evacuation.md`
