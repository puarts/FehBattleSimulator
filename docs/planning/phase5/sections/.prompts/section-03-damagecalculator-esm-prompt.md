...
Generate content for section `section-03-damagecalculator-esm` (filename: `section-03-damagecalculator-esm.md`).
...
for `section-03-damagecalculator-esm` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase5/sections/section-03-damagecalculator-esm.md`
