...
Generate content for section `section-04-skilleffect-esm` (filename: `section-04-skilleffect-esm.md`).
...
for `section-04-skilleffect-esm` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase5/sections/section-04-skilleffect-esm.md`
