...
Generate content for section `section-05-verification` (filename: `section-05-verification.md`).
...
for `section-05-verification` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase5/sections/section-05-verification.md`
