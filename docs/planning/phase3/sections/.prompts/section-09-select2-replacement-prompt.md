...
Generate content for section `section-09-select2-replacement` (filename: `section-09-select2-replacement.md`).
...
for `section-09-select2-replacement` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase3/sections/section-09-select2-replacement.md`
