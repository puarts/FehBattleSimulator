...
Generate content for section `section-11-jquery-removal` (filename: `section-11-jquery-removal.md`).
...
for `section-11-jquery-removal` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase3/sections/section-11-jquery-removal.md`
