...
Generate content for section `section-04-vitest-migration` (filename: `section-04-vitest-migration.md`).
...
for `section-04-vitest-migration` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase3/sections/section-04-vitest-migration.md`
