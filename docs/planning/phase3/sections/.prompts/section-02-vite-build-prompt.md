...
Generate content for section `section-02-vite-build` (filename: `section-02-vite-build.md`).
...
for `section-02-vite-build` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase3/sections/section-02-vite-build.md`
