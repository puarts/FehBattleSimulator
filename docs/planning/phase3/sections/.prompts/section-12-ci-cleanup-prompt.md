...
Generate content for section `section-12-ci-cleanup` (filename: `section-12-ci-cleanup.md`).
...
for `section-12-ci-cleanup` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase3/sections/section-12-ci-cleanup.md`
