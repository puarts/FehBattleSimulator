...
Generate content for section `section-03-vitest-setup` (filename: `section-03-vitest-setup.md`).
...
for `section-03-vitest-setup` to understand what this section should contain.
...
`/Users/studio/Documents/GitHub/FehBattleSimulator/docs/planning/phase3/sections/section-03-vitest-setup.md`
